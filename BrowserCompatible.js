...
var BrowserCompatible = {
	...
	cookiesExpire: 1,
	images : {
		'background':"browser/bg.gif",
		'cancel':"browser/cancel.gif"
	},
	useBlackList: false,
	compatibleBrowsers: {
		"Opera": 9.25,
	...
	offeredBrowsers: ["Chrome","Firefox", "IExplorer", "Opera"],
	browsersList: {
		"Chrome": {
			"image": "browser/chrome.gif",
			"link": "http://www.google.com/chrome/"
		},
		"Opera": {
			"image": "browser/opera.gif",
			"link": "http://www.opera.com/products/desktop/"
		},
		"Firefox": {
			"image": "browser/firefox.gif",
			"link": "http://www.mozilla.org"
		},
		"IExplorer": {
			"image": "browser/iexplorer.gif",
	...
	langTranslations: {
		"en": {
			...
			"description": "Your browser is obsolete, which means it does not contain all of the necessary functions for the correct working of this web sites. Modern web sites are created to be convenient and effective for you and, together with improvement of web sites themselves, browsers continue to improve. In addition, older browsers have many security glitches which can be maliciously abused to steal personal and financial information; therefore by upgrading your web browser you not only benefit from an enhanced web experience, but ensure that your private data is better protected.",
			"recomendation": "We recommend using the latest version of one of the following browsers. All are free, quick to install and won't cost you anything.<br><br>Please click on the icon below to download it from the website and for slower connections please click <a href=\"file/Firefox Setup 3.5.6.exe\"><b>here</b></a> to download it from our server.",
