...
<div align="center" class="tajuk">
    <a href="javascript:openScript('all_other_cost_draft.php?year=<?php echo $year; ?>&state=<?php echo $state; ?>&sub=<?php echo $sub; ?>&area=<?php echo $area; ?>','800','600')" >View Draft</a>
</div>
