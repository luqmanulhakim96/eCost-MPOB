...
<!-- ampie script-->
  ...
  <script type="text/javascript" src="../js/swfobject.js"></script>
	<div><b>&nbsp;&nbsp;&nbsp;Palm Oil Production Cost Jan - Jul 2009</b></div>
	<br />
...
<div id="flashcontent">
	...
	<script type="text/javascript">
		...
		so.addVariable("settings_file", encodeURIComponent("../xml/ampie_settings.xml"));                // you can set two or more different settings files here (separated by commas)
		so.addVariable("data_file", encodeURIComponent("../xml/ampie_data.xml"));
