<?php session_start(); include('../Connections/connection.class.php');
include('baju.php');
   ...
   <tr>
     ...
     <td width="88%"><input type="text" name="purata_hasil_buah" id="purata_hasil_buah" value="<?php echo $rowfbb['purata_hasil_buah'];?>" />
      ...
      var purata_hasil_buah = new LiveValidation('purata_hasil_buah');
       ...
       <input name="lesen_singkat" type="hidden" id="lesen_singkat" value="<?php echo $lesen_singkat; ?>" /></td>
   </tr>
 </table>
 </p>
...
<b><em>JUMLAH KESELURUHAN : <?php echo $jumlah2; ?></em></b>
 ...
 <table width="60%" align="center" cellpadding="2" cellspacing="2" class="baju">
  ...
  ?>		<tr <?php if(++$rs2%2==0){?>class="alt"<?php } ?>>
    ...
    <td width="9%"><div align="center"><a href="save_all.php?type=delete&amp;lesen=<?php echo $nolesen; ?>&amp;bulan=<?php echo $row['bulan'];?>&amp;luas=<?php echo $row['tanaman_baru'];?>&amp;table=<?php echo "tanam_baru$ketiga";?>&amp;field=<?php echo "tanaman_baru"; ?>"><img src="../images/remove.png" width="20" height="20" border="0" onclick="return confirm('Buang data ini?');" /></a></div></td>
  </tr>
  <?php } ?>
</table>
...
<tr <?php if(++$rs3%2==0){?>class="alt"<?php } ?>>    <td width="29%"><?php echo $row['bulan'];?></td>
    ...
    <td width="9%"><div align="center"><a href="save_all.php?type=delete&amp;lesen=<?php echo $nolesen; ?>&amp;bulan=<?php echo $row['bulan'];?>&amp;luas=<?php echo $row['tanaman_semula'];?>&amp;table=<?php echo "tanam_semula$pertama";?>&amp;field=<?php echo "tanaman_semula"; ?>"><img src="../images/remove.png" alt="" width="20" height="20" border="0" onclick="return confirm('Buang data ini?');" /></a></div></td>
  </tr>
  <?php } ?>
</table>
...
<b><em>JUMLAH KESELURUHAN : <?php echo $jumlahb2; ?></em></b>
 ...
 <tr <?php if(++$rs6%2==0){?>class="alt"<?php } ?>>
    ...
    <td width="64%"><?php echo $row['tanaman_tukar'];$jumlahb3=$jumlahb3+$row['tanaman_tukar'];?></td>
    <td width="10%"><div align="center"><a href="save_all.php?type=delete&amp;lesen=<?php echo $nolesen; ?>&amp;bulan=<?php echo $row['bulan'];?>&amp;luas=<?php echo $row['tanaman_tukar'];?>&amp;table=<?php echo "tanam_tukar$ketiga";?>&amp;field=<?php echo "tanaman_tukar"; ?>"><img src="../images/remove.png" alt="" width="20" height="20" border="0" onclick="return confirm('Buang data ini?');" /></a></div></td>
  </tr>
  <?php } ?>
</table>
