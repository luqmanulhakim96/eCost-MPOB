...
class progress_bar
{
	...
	*/
	...
	function create()
	{
		?>
			<div align="left">
		  <table height="20" name="<?php echo('table_' . $this->name);?>" border="0" cellpadding="0" cellspacing="0" width="<? echo($this->width + 60);?>">
			<tr>
              <td width="72" height="20"><p>&nbsp;Progress : &nbsp; </p></td>
		      <td name="<?php echo('cell_' . $this->name);?>" align="left" valign="middle" width="<? echo($this->width);?>" height="10" style="background-repeat: repeat-x" background="fill_bg2.gif"><img name="<? echo($this->name)?>" border="0" src="fill.gif" width="<? echo(($percent * .01) * $width);?>" height="11"></td>
		      <td width="4"  height="20" valign="top" align="left"><img border="0" src="fill_bg.gif" width="4" height="20"></td>
		    </tr>
		  </table>
		</div>
		<?
