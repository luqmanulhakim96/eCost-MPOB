  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" style="padding:3px;">
		<tr height="29">
			...
			<td background="../images/tb_BG.gif"><div align="center"><strong>Complete Response</strong></div></td>
			<td background="../images/tb_BG.gif"><div align="center"><strong>Incomplete Response</strong></div></td>
		...
		<tr height="29">
			...
			<td bgcolor="#FFCC66"><div align="center"><a href="home.php?id=estate&amp;sub=total_complete"><?php echo $total_complete;?></a></div></td>
			<td bgcolor="#FFCC66"><div align="center"><a href="home.php?id=estate&amp;sub=total_incomplete"><?php echo $total_incomplete;?></a></div></td>
		...
		<tr height="29">
			...
			<td bgcolor="#99FF99"><div align="center"><a href="home.php?id=estate&amp;sub=total_peninsular_complete"><?php echo $total_peninsular_complete;?></a></div></td>
			<td bgcolor="#99FF99"><div align="center"><a href="home.php?id=estate&amp;sub=total_incomplete_peninsular"><?php echo $total_peninsular_incomplete;?></a></div></td>
		...
		<tr height="29">
			...
			<td bgcolor="#FFCC66"><div align="center"><a href="home.php?id=estate&amp;sub=total_sabah_complete"><?php echo $total_sabah_complete;?></a></div></td>
			<td bgcolor="#FFCC66"><div align="center"><a href="home.php?id=estate&amp;sub=total_incomplete_sabah"><?php echo $total_sabah_incomplete;?></a></div></td>
		...
		<tr height="29">
			...
			<td bgcolor="#99FF99"><div align="center"><a href="home.php?id=estate&amp;sub=total_sarawak_complete"><?php echo $total_sarawak_complete;?></a></div></td>
			<td bgcolor="#99FF99"><div align="center"><a href="home.php?id=estate&amp;sub=total_incomplete_sarawak"><?php echo $total_sarawak_incomplete;?></a></div></td>
    ...
    <table width="100%" border="0" cellspacing="0" style="padding:3px;">
      <tr height="29">
			...
			<td background="../images/tb_BG.gif"><div align="center"><strong>Response</strong></div></td>
			<td background="../images/tb_BG.gif"><div align="center"><strong>Complete Response</strong></div></td>
			<td background="../images/tb_BG.gif"><div align="center"><strong>Incomplete Respose</strong></div></td>
			<td background="../images/tb_BG.gif"><div align="center"><strong>Response Rate (%)</strong></div></td>
			<td background="../images/tb_BG.gif"><div align="center"><strong>Non Response</strong></div></td>
		</tr>
		<tr height="29">
          <td bgcolor="#FFCC66"><strong>Sabah</strong></td>
		  <td bgcolor="#FFCC66"><div align="center"><?php echo number_format($total_sb);?></div></td>
		  <td bgcolor="#FFCC66"><div align="center"><a href="home.php?id=estate&amp;sub=total_sabah"><?php echo number_format($total_sabah);?></a></div></td>
		  <td bgcolor="#FFCC66"><div align="center"><a href="home.php?id=estate&amp;sub=total_sabah_complete"><?php echo $total_sabah_complete;?></a></div></td>
		  <td bgcolor="#FFCC66"><div align="center"><a href="home.php?id=estate&amp;sub=total_incomplete_sabah"><?php echo $total_sabah_incomplete;?></a></div></td>
    ...
    <table width="100%" border="0" cellspacing="0" style="padding:3px;">
      <tr height="29">
		...
		<tr height="29">
          <td bgcolor="#99FF99"><strong>Sarawak</strong></td>
		  <td bgcolor="#99FF99"><div align="center"><?php echo number_format($total_sw);?></div></td>
		  <td bgcolor="#99FF99"><div align="center"><a href="home.php?id=estate&amp;sub=total_sarawak"><?php echo number_format($total_sarawak);?></a></div></td>
		  <td bgcolor="#99FF99"><div align="center"><a href="home.php?id=estate&amp;sub=total_sarawak_complete"><?php echo $total_sarawak_complete;?></a></div></td>
		  <td bgcolor="#99FF99"><div align="center"><a href="home.php?id=estate&amp;sub=total_incomplete_sarawak"><?php echo $total_sarawak_incomplete;?></a></div></td>
...
<area id="sabah" shape="poly" title="Region 3 (Sabah)" coords="299,63,314,51,328,30,341,32,349,43,358,52,372,60,388,69,377,76,364,80,369,87,354,92,335,92,315,92,306,93" href="home.php?id=estate&amp;sub=response_rate&amp;region=sabah" />
<area id="sarawak" shape="poly" title="Region 2 (Sarawak)" coords="300,77,286,79,275,86,256,97,242,116,217,122,203,138,196,155,186,159,171,151,168,146,175,165,184,171,209,170,227,157,248,160,265,160,281,145,286,133,299,116,302,100,308,95,304,107,305,99" href="home.php?id=estate&amp;sub=response_rate&amp;region=swk" />
</map>
