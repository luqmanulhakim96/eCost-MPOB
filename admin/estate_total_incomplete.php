...
<div align="center">
  <h2>List of Incompleted Response Survey in Malaysia</h2>
</div>
...
<thead>
	...
	<?php
	$con = connect();
	$qr="select lesen,success,password from login_estate";
	if($year=="2010"){$qr.= " WHERE login_estate.success != '0000-00-00 00:00:00'";
	}
	if($year!="2010"){	$qr.= " WHERE login_estate.success like '%$year%'";
	}
	$qr.=" group by lesen";
