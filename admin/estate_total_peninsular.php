...
<div align="center">
  <h2>List of All Estate Response Survey in <?php echo $tempat;?></h2>
</div>
...
<?php if(isset($negeri)){
	if(isset($district)){
?>
	<a href="estate_total_peninsular_excel.php?negeri=<?php echo $negeri;?>&amp;district=<?php echo $district;?>" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
	}else{
?>
	<a href="estate_total_peninsular_excel.php?negeri=<?php echo $negeri;?>" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
	}
}else{
?>
	<a href="estate_total_peninsular_excel.php" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
}
?>
