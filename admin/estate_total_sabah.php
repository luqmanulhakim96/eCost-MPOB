...
<div align="center">
  <h2>List of All Estate Response Survey in <?php echo $tenpat;?></h2>
</div>
...
if(isset($district)){
?>
	<a href="estate_total_sabah_excel.php&amp;district=<?php echo $district;?>" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
}else{
?>
	<a href="estate_total_sabah_excel.php" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
}
?>
