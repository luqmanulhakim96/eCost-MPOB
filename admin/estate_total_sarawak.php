...
if(isset($district)){
?>
	<a href="estate_total_sarawak_excel.php?district=<?php echo $district;?>" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
}else{
?>
	<a href="estate_total_sarawak_excel.php" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
}
?>
