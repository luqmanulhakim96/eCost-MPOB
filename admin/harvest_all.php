...
<a href="javascript:openScript('harvest_all_draft.php?year=<?php echo $year; ?>&state=<?php echo $state; ?>&sub=<?php echo $sub; ?>','800','600')" >View Draft</a>
</div>
<br />
