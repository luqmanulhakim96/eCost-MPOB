...
<table width="100%">
  ...
  <tr>
    ...
    <td><div id="grey-button"> <a href="javascript:openScript('linear_immature_graph_view.php?tahun=<?php echo $tahun; ?>&amp;type=<?php echo $type;?>&amp;field=Planting material','','')" class="grey-button pcb"> <span>Planting material</span> </a> </div>
  ...
  <tr>
    <td><div id="grey-button"> <a href="javascript:openScript('linear_immature_graph_view.php?tahun=<?php echo $tahun; ?>&amp;type=<?php echo $type;?>&amp;field=Soil and foliar analysis','','')" class="grey-button pcb"> <span>iv. Soil and foliar analysis</span> </a> </div>
