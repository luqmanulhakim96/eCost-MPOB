...
, sum(pow(x,2)) as sumx2, count(*) as n, SUM(x * y) as sumxy FROM graf_kbm where sessionid='$field' and tahun = '" . $_COOKIE['tahun_report'] ."' and pb_tahun='$tahun' and pb_type='$type' and status ='0'
";
