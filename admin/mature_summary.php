...
<div align="center" class="tajuk">
    <a href="javascript:openScript('mature_summary_draft.php?year=<?php echo $year; ?>&state=<?php echo $state; ?>&sub=<?php echo $sub; ?>','800','600')" >View Draft</a>
</div>
...
<table width="80%" align="center" class="baju">
    ...
    <tr height="17" class="alt">
        ...
        <td width="68"><div align="center"><?php $ah = (($s[2] - $s[0]) / $s[0]) * 100;
        ...
        <td align="right"><div align="center"><?php $ah2 = (($s[3] - $s[1]) / $s[1]) * 100;
...
?>
    ...
    <tr height="17">
        ...
        <td width="68"><div align="center"><?php $bh = (($t[2] - $t[0]) / $t[0]) * 100;
        ...
        <td align="right"><div align="center"><?php $bh2 = (($t[3] - $t[1]) / $t[1]) * 100;
    ...
    <tr height="17" class="alt">
        ...
        <td width="68"><div align="center"><?php $ch = (($u[2] - $u[0]) / $u[0]) * 100;
        ...
        <td align="right"><div align="center"><?php $ch2 = (($u[3] - $u[1]) / $u[1]) * 100;
    ...
    <tr height="17">
        ...
        <td width="68"><div align="center"><?php $gh = (($g[2] - $g[0]) / $g[0]) * 100;
        ...
        <td align="right"><div align="center"><?php $gh2 = (($g[3] - $g[1]) / $g[1]) * 100;
    ...
    <tr height="17">
        ...
        <td align="right" bgcolor="#FF9966"><div align="center"><?php $sa = $s[0] + $t[0] + $u[0] + $g[0];
                echo number_format($sa, 2);
                ?></div></td>
        <td align="right" bgcolor="#FF9966"><div align="center"><?php $sb = $s[2] + $t[2] + $u[2] + $g[2];
                echo number_format($sb, 2);
                ?></div></td>
        <td align="right" bgcolor="#FF9966"><div align="center"><?php $jch = (($sb - $sa) / $sa) * 100;
                echo number_format($jch, 2);
                ?></div></td>
        <td align="right" bgcolor="#FF9966"><div align="center"><?php $sc = $s[1] + $t[1] + $u[1] + $g[1];
            echo number_format($sc, 2);
                ?></div></td>
        <td align="right" bgcolor="#FF9966"><div align="center"><?php $sd = $s[3] + $t[3] + $u[3] + $g[3];
            echo number_format($sd, 2);
                ?></div></td>
        <td align="right" bgcolor="#FF9966"><div align="center"><?php $jch2 = (($sd - $sc) / $sc) * 100;
