...
<table width="80%" align="center" class="baju">
  ...
  <tr height="17">
    <td height="17" colspan="7"><div align="center" class="style6">Cost of Estate Upkeep and Cultivation for Public Agencies</div></td>
  </tr>
  <?php } else if ($state == "cooperatives") { ?>
  <tr height="17">
    <td height="17" colspan="7"><div align="center" class="style6">Cost of Estate Upkeep and Cultivation for Cooperatives</div></td>
  </tr>
  <?php } else if ($state == "publiclimitedcompany") { ?>
  <tr height="17">
    <td height="17" colspan="7"><div align="center" class="style6">Cost of Estate Upkeep and Cultivation for Public Limited Company</div></td>
  </tr>
  <?php } else if ($state == "partnership") { ?>
  <tr height="17">
    <td height="17" colspan="7"><div align="center" class="style6">Cost of Estate Upkeep and Cultivation for Partnership</div></td>
  </tr>
  <?php } else if ($state == "solepropriertorship") { ?>
  <tr height="17">
    <td height="17" colspan="7"><div align="center" class="style6">Cost of Estate Upkeep and Cultivation for Sole Propriertorship</div></td>
  </tr>
  <?php } else if ($state == "privatelimitedcompany") { ?>
  <tr height="17">
    <td height="17" colspan="7"><div align="center" class="style6">Cost of Estate Upkeep and Cultivation for Private Limited Company</div></td>
  </tr>
  <?php } else { ?>
	<tr height="17">
...
while ($rows = mysqli_fetch_array($rs)) {
    ?>
        ...
        if ($rows['isChild'] == 'N' && strlen($rows['sub_type']) > 0) {
            ...
            echo number_format($totalAll2, 2); ?></div></td>
                    ...
                    <td width="68"><div align="right"><?php $totalAll3 = $total4[1] + $total5[1] + $total6[1];
            echo number_format($totalAll3, 2); ?></div></td>
                    <td width="68"><div align="right"><?php $totalAll4 = $total1[1] + $total2[1] + $total3[1];
            echo number_format($totalAll4, 2); ?></div></td>
                    <td width="68"><div align="right"><?php
                    $sumtotalall3 = 0;
                    if ($totalAll3 > 0) {
                        $sumtotalall3 = ($totalAll4 - $totalAll3) / $totalAll3;
                    }
                    echo number_format(($sumtotalall3) * 100, 2)
                    ?></div></td>
                            <?php
                            ...
                            ?>
                    <td width="68"><div align="right"><?php $totalAll1 = $total5[0] + $total6[0] + $total7[0] + $total8[0];
            echo number_format($totalAll1, 2); ?></div></td>
                    <td width="68"><div align="right"><?php $totalAll2 = $total1[0] + $total2[0] + $total3[0] + $total4[0];
            echo number_format($totalAll2, 2); ?></div></td>
                    <td width="68"><div align="right"><?= number_format((($totalAll2 - $totalAll1) / $totalAll1) * 100, 2) ?></div></td>
                    <td width="68"><div align="right"><?php $totalAll3 = $total5[1] + $total6[1] + $total7[1] + $total8[1];
            echo number_format($totalAll3, 2); ?></div></td>
                    <td width="68"><div align="right"><?php $totalAll4 = $total1[1] + $total2[1] + $total3[1] + $total4[1];
            echo number_format($totalAll4, 2); ?></div></td>
    ...
    echo number_format(($sumtotaljl) * 100, 2);
        ?></div></td>
        ...
        <td align="right" ><div align="right"><?php
                ...
                echo number_format(($sumtotalml) * 100, 2);
        ?></div></td>
    </tr>
</table>
<br />
