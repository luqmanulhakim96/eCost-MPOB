...
<table width="80%" align="center" class="baju">
  ...
  ?>
  <?php
  $qs="select * from q_km where type='upk' and sub_type='fertiliser'";
  ...
  <tr height="17" <?php if(++$gg%2==0){?>class="alt"<?php } ?>>
	...
	echo number_format($a1[0],2);$jl = $jl+$a1[0]; ?>
      </div></td>
    <td width="104"><div align="right"><?php echo number_format($b1[0],2); $js =  $js+$b1[0];?></div></td>
    <td width="68">
      <div align="right">
        <?php $ubah = ($a1[0]-$b1[0])/$b1[0]*100; echo number_format($ubah,2);$perubahan = $perubahan+$ubah; ?>
      </div></td>
    <td align="right"><div align="right"><?php echo number_format($a1[1],2);$ml = $ml+$a1[1]; ?></div></td>
    <td align="right"><div align="right"><?php echo number_format($b1[1],2); $ms= $ms+$b1[1]; ?></div></td>
    <td align="right">
      <div align="right">
        <?php $ubah_baru = ($a1[1]-$b1[1])/$b1[1]*100; echo number_format($ubah_baru,2);$perubahan_baru = $perubahan_baru+$ubah_baru; ?>
      </div></td>
  </tr>
  <?php } ?>
  <tr height="17" class="kaki">
    ...
    <td align="right" ><div align="right"><?php echo number_format($perubahan,2);?></div></td>
    ...
    <td align="right" ><div align="right"><?php echo number_format($perubahan_baru,2);?></div></td>
  </tr>
</table>
<br />
<br />
