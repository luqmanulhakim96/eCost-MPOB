...
<form id="form1" name="form1" method="post" action="">
    ...
    <tr>
      <td><div align="center">
        <select name="menu1" onchange="MM_jumpMenu('parent',this,0)">
          <option value="#">-</option>
          <option value="home.php?id=replanting_company&amp;comp=A" selected="selected">Company A</option>
          <option value="home.php?id=replanting_company&amp;comp=B">Company B</option>
          <option value="home.php?id=replanting_company&amp;comp=C">Company C</option>
  ...
  <table width="100%" cellpadding="4" cellspacing="0" style="border-collapse:collapse">
    ...
    <tr >
      <td  colspan="5"><div align="center"><strong>Cost of Oil Plant Replanting for Company <?php echo $comp;?> (RM Per Hectare) </strong> <a href="home.php?id=company_profile">Company Profile</a></div></td>
    </tr>
    <tr >
      <td  colspan="5">
