  ...
  <tr valign="top">
    ...
    <td width="45%"><form name="form" id="form">
      <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
        <option value="home.php?id=estate&sub=new_conversion_state&year=1&state=<?= $state; ?>" <?php if($year=='1'){?>selected="selected" <?php } ?>>Year 1</option>
        <option value="home.php?id=estate&amp;sub=new_conversion_state&amp;year=2&state=<?= $state; ?>" <?php if($year=='2'){?>selected="selected" <?php } ?>>Year 2</option>
        <option value="home.php?id=estate&amp;sub=new_conversion_state&amp;year=3&state=<?= $state; ?>" <?php if($year=='3'){?>selected="selected" <?php } ?>>Year 3</option>
        </select>
    </form>    </td>
    <td width="45%">
	<?php $con = connect();
...
<tr>
<td colspan="5"><strong>Cost in the First Year of Oil Palm Conversion(RM per hectare) </strong></td>
</tr>
  <tr bgcolor="#8A1602">
...
<table width="85%" align="center" cellpadding="4" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
<td colspan="5"><strong>Cost in the Second Year of Oil Palm Conversion(RM per hectare) </strong></td>
</tr>
  <tr bgcolor="#8A1602">
    <td width="34%" rowspan="2"><span class="style5">Cost Items </span></td>
    <td bgcolor="#8A1602"><div align="center" class="style5">
...
<table width="85%" align="center" cellpadding="4" cellspacing="0" style="border-collapse:collapse">
  <tr>
<td colspan="5"><strong>Cost in the Third Year of Oil Palm Conversion(RM per hectare) </strong></td>
</tr>
  <tr bgcolor="#8A1602">
    <td width="34%" rowspan="2"><span class="style5">Cost Items </span></td>
    <td bgcolor="#8A1602"><div align="center" class="style5">
