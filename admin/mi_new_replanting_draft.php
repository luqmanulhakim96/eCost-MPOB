...
function pertama($tahun, $nama, $status, $negeri, $daerah, $type, $tahuntanam) {
    global $con;
    $sql = "SELECT * FROM graf_kbm where sessionid='$nama' and tahun ='$tahun' "
            . "and (status='$status' or status='9') "
            . "and pb_type = '$type' and pb_tahun = '$tahuntanam'";
    if ($negeri != "" & $negeri != "pm") {
    ...
    $qavg = "SELECT AVG(y) as purata FROM graf_kbm where sessionid='$nama' and tahun ='$tahun' "
            . "and (status='$status' or status='9') "
            . "and pb_type='$type' and pb_tahun = '$tahuntanam'";
    if ($negeri != "" & $negeri != "pm") {
    ...
    <tr <?php if (++$gg % 2 == 0) { ?>class="alt"<?php } ?>>
        ...
        if ($rows['isChild'] == 'N' && strlen($rows['sub_type']) > 0) {
            if ($rows['sub_type'] == "weeding") {
				...
				echo number_format(($sumtotalall) * 100, 2); ?></div></td>
                <?php
				...
				echo number_format(($sumtotalall2) * 100, 2); ?></div></td>
                <?php
            }
        } else {
