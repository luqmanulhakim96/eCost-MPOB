...
<table width="100%" class="baju">
  ...
  <tr <?php if(++$l%2==0){?>class="alt"<?php } ?>>
    ...
    <td><div align="center"><a href="home.php?id=estate&amp;sub=age_profile&state=<?php echo $row['nama'];?>&district=<?php echo $rowd['district_name'];?>">View</a></div></td>
  </tr>
  <?php } ?>
</table>
<p><a href="home.php?id=estate&amp;sub=age_profile&state=<?php echo $row['nama'];?>">View Report by State</a></p>
