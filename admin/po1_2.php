...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2"><table width="99%" align="center" >
	  ...
	  $rpa = mysqli_query($con, $qpa);
	  while ($rowrpa = mysqli_fetch_array($rpa)){
	  ?>
      <tr align="center">
  ...
  <tr>
    <td colspan="2"><table width="99%" align="center" id="box-table-a" style="border:#333333 1px solid;">
	  ...
	  $rj = mysqli_query($con, $qj);
	  $j=0;
	  while($rowrj = mysqli_fetch_array($rj)){
	  ?>
      <tr>
	  ...
	  $rjen = mysqli_query($con, $qjen);
	  $jen=0;
	  while($rowrjen = mysqli_fetch_array($rjen)){
