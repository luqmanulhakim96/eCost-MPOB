  ...
  <tr>
    ...
    <td colspan="4"><table width="80%"  frame="box" class="subTable">
      ...
      <tr>
        ...
        <td><input name="txtCa16" type="text" onblur="kiraTotal(this.value,'txtCa28')" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/></td>
        <td><input name="txtCa28" type="text" value="0" size="10" /></td>
        <td><input name="txtCa4" type="text" value="0" size="10" /></td>
      </tr>
      <tr>
        <td align="center">5.</td>
        <td>Pemuliharan tanah/air&nbsp;[<i>Soil/water conservation</i>]</td>
        <td><input name="txtCa17" type="text" onblur="kiraTotal(this.value,'txtCa29')" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/>        </td>
      ...
      <tr>
        ...
        <td><input name="txtCa18" type="text" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa19" type="text" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa20" type="text" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa21" type="text" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa22" type="text" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa23" type="text" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa24" type="text" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15"/></td>
