...
<settings> 
  ...
  <column>
    ...
    <data_labels>
      <![CDATA[{percents}%]]>                                 <!-- [] ({title} {value} {series} {percents} {start} {difference} {total}) You can format any data label: {title} will be replaced with real title, {value} - with value and so on. You can add your own text or html code too. -->
    </data_labels>
    ...
    <balloon_text>                                                    
      <![CDATA[In {series} {percents}%  of Estate Respondents for Immature Stage ({title})</b>]]>                                            <!-- [] ({title} {value} {series} {percents} {start} {difference} {total}) You can format any data label: {title} will be replaced with real title, {value} - with value and so on. You can add your own text or html code too. -->
    </balloon_text>    
  ...
  <plot_area>                                                 <!-- PLOT AREA (the area between axes) -->
    ...
    <margins>                                                 <!-- plot area margins -->
      ...
      <top>80</top>                                           <!-- [60](Number) --> 
      <right>155</right>                                      <!-- [60](Number) -->
      <bottom>90</bottom>                                     <!-- [80](Number) -->
    </margins>
  </plot_area>
