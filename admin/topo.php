...
<table width="29%" border="0" align="center" style="border:solid 1px #333333;">
  <tr>
    <td width="45%"><div align="left">Select Topography</div></td>
    <td width="55%"><form name="form" id="form">
      <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
        <option value="#">Hill</option>
...
<script type="text/javascript" src="amcolumn/swfobject.js"></script>
	...
	<script type="text/javascript">
		...
		so.addVariable("settings_file", encodeURIComponent("topo_settings.xml"));
		so.addVariable("data_file", encodeURIComponent("mi_all.xml"));
...
<table width="100%" cellpadding="4" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr >
    <td  colspan="5"><div align="center"><strong>Cost of Oil Plant <?= $title ?>  (RM Per Hectare) </strong></div></td>
  </tr>
  <tr >
