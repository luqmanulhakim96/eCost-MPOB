...
if(isset($negeri)){
?>
	<a href="total_peninsular_excel.php?negeri=<?php echo $negeri;?>" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
}else{
?>
	<a href="total_peninsular_excel.php" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<?php
}
?>
