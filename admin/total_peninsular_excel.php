...
if(isset($negeri)){
	header("Content-Disposition: attachment; filename=List_of_All_Mill_Response_Survey_in_$negeri.xls");
}else{
	header("Content-Disposition: attachment; filename=List_of_All_Mill_Response_Survey_in_Peninsular.xls");
}
?>
<style type="text/css">
<!--
