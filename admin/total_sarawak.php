...
include('pages.php');
?>
      <div align="center"><strong>List of Completed Response Survey in Sarawak</strong></div>
...
<br />
&nbsp;&nbsp;&nbsp;
<a href="total_sarawak_excel.php" target="_blank"><img src="../images/Excel-icon.png" width="48" height="48" border="0" title="Pindah ke Excel" /></a><br/>
<br />
<br />
