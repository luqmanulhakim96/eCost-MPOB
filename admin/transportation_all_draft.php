...
<table width="80%" align="center" class="baju">
 ...
 <?php
  ...
  <tr height="17" <?php if(++$gg%2==0){?>class="alt"<?php } ?>>
	...
	echo number_format(($sumtotalall1)*100,2)?></div></td>
	...
	echo number_format(($sumtotalall3)*100,2)?></div></td>
    <?php
	}else{
    ...
    <?php
	if($a1[1]>0){
	$totalallsum=($b1[1]-$a1[1])/$a1[1];
	}
	echo number_format(($totalallsum)*100,2);
	?>
    </div></td>
    <?php
	}
  ...
  <tr height="17" class="kaki">
	...
	echo number_format(($sumtotaljl)*100,2);?></div></td>
	...
	echo number_format(($sumtotalml)*100,2);?></div></td>
  </tr>
</table>
<br />
<br />
