<?php
	...
	$result_total = mysqli_query($total,$con);
	...
	$result_total_p = mysqli_query($total_p,$con);
	...
	//echo $total_sb; 
	$result_total_sb = mysqli_query($total_sb,$con);
	...
	$result_total_sw = mysqli_query($total_sw,$con);
...
*/
	...
	$result_all = mysqli_query($all,$con);
...
//	echo $all_complete;
	...
	$result_complete 	= mysqli_query($all_complete,$con);
	...
	//echo $all_incomplete;
	$result_incomplete 	= mysqli_query($all_incomplete,$con);
...
le.lesen = es.no_lesen_baru  ";
	...
	$result_peninsular = mysqli_query($peninsular,$con);
	...
	$result_peninsular_complete = mysqli_query($all_peninsular,$con);
...
le.lesen = es.no_lesen_baru  ";
	...
	//echo $sabah;
	$result_sabah = mysqli_query($sabah,$con);
	...
	$result_sabah_complete = mysqli_query($all_sabah,$con);
...
le.lesen = es.no_lesen_baru  ";
	...
	$result_sarawak = mysqli_query($sarawak,$con);
	...
	$result_sarawak_complete 	= mysqli_query($all_sarawak,$con);
