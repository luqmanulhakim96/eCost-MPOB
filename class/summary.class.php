...
/*	function __construct()
	...
	*/
	...
	function immature_cost_hectare($location)
	{
		...
		$result_kos_belum_matang 	= mysql_query($query_kos_belum_matang) or die(mysql_error());
		$row 						= mysql_fetch_object($result_kos_belum_matang) or die(mysql_error());
	...
	function matang_tuai($location)
	{
		...
		$result_matang_tuai 	= mysql_query($query_matang_tuai) or die(mysql_error());
		$row 						= mysql_fetch_object($result_matang_tuai) or die(mysql_error());
	...
	function matang_jaga($location)
	{
		...
		$result_matang_jaga 	= mysql_query($query_matang_jaga) or die(mysql_error());
		$row 						= mysql_fetch_object($result_matang_jaga) or die(mysql_error());
	...
	function matang_angkut($location)
	{
		...
		$result_matang_angkut 	= mysql_query($query_matang_angkut) or die(mysql_error());
		$row 						= mysql_fetch_object($result_matang_angkut) or die(mysql_error());
	...
	function mill_oer($location)
	{
		...
		$result_mill_oer 	= mysql_query($query_mill_oer) or die(mysql_error());
		$row 				= mysql_fetch_object($result_mill_oer) or die(mysql_error());
	...
	function mill_cpo($location)
	{
		...
		$result_mill_cpo 	= mysql_query($query_mill_cpo) or die(mysql_error());
		$row 				= mysql_fetch_object($result_mill_cpo) or die(mysql_error());
		$mill_cpo			= $row->cpo;
	...
	function mill_pk($location)
	{
		...
		$result_mill_pk 	= mysql_query($query_mill_pk) or die(mysql_error());
		$row 				= mysql_fetch_object($result_mill_pk) or die(mysql_error());
		$mill_pk			= $row->pk;
