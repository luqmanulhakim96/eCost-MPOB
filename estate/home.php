...
<?php if (isset($_GET['ringkasan'])) {
    ...
    for ($startPilihTahun = 2011; $startPilihTahun < date('Y'); $startPilihTahun++) {
        ?>
                                        <option value="<?php echo $startPilihTahun ?>">eCOST <?php echo $startPilihTahun ?> (Tahun kewangan Jan-Dis <?php echo $startPilihTahun-1;?>)</option>
        <?php
    }
    ?>
                                    <option value="<?php echo date('Y') ?>" selected="selected">eCOST <?php echo date('Y') ?> (Tahun kewangan Jan-Dis <?php echo date('Y')-1;?>)</option>
                                </select>        </td>
                        </tr>
