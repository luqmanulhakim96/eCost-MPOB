...
<table width="90%" align="center" class="tableCss" aria-describedby="umuma">
  ...
  <tr>
    <td colspan="5"><table width="100%" aria-describedby="umuma1">
      <tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0"  frame="box" class="subTable">
      ...
      <tr>
        ...
        <td bgcolor="#CCCCFF"><div align="center">
          <input onKeypress="keypress(event)" name="b_1a" type="text" class="field_active" id="b_1a" onchange="kiraan_baru(this,'anak');$('#total_b_1').attr('disabled','disabled');"  value="<?= number_format($jaga->b_1a,2); ?>" size="15" />
        </div></td>
      ...
      <tr>
        ...
        <td bgcolor="#CCCCFF"><div align="center">
          <input onKeypress="keypress(event)" name="b_1b" type="text" class="field_active" id="b_1b" onchange="kiraan_baru(this,'anak');$('#total_b_1').attr('disabled','disabled')" value="<?= number_format($jaga->b_1b,2); ?>" size="15" />
        </div></td>
      ...
      <tr>
        ...
        <td bgcolor="#CCCCFF"><div align="center">
          <input onKeypress="keypress(event)" name="b_1c" type="text" class="field_active" id="b_1c" onchange="kiraan_baru(this,'anak');$('#total_b_1').attr('disabled','disabled')"  value="<?= number_format($jaga->b_1c,2); ?>" size="15" />
        </div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          <input onKeypress="keypress(event)" name="b_3a" type="text" class="field_active" id="b_3a" onchange="kiraan_baru(this,'anak');$('#total_b_3').attr('disabled','disabled');"  value="<?= number_format($jaga->b_3a,2); ?>" size="15" />
        </div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          <input onKeypress="keypress(event)" name="b_3b" type="text" class="field_active" id="b_3b" onchange="kiraan_baru(this,'anak');$('#total_b_3').attr('disabled','disabled');"  value="<?= number_format($jaga->b_3b,2); ?>" size="15" />
        </div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          <input onKeypress="keypress(event)" name="b_3c" type="text" class="field_active" id="b_3c" onchange="kiraan_baru(this,'anak');$('#total_b_3').attr('disabled','disabled')"  value="<?= number_format($jaga->b_3c,2); ?>" size="15" />
        </div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          <input onKeypress="keypress(event)" name="b_3d" type="text" class="field_active" id="b_3d" onchange="kiraan_baru(this,'anak');$('#total_b_3').attr('disabled','disabled');"  value="<?= number_format($jaga->b_3d,2); ?>" size="15" />
        </div></td>
...
:</td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#CCCCFF"><div align="center">
            <input onKeypress="keypress(event)" name="a_1" type="text" class="field_active" id="a_1" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_1').attr('disabled','disabled');" value="<?= number_format($angkut->a_1,2); ?>" size="15" />
          </div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#CCCCFF"><div align="center">
            <input onKeypress="keypress(event)" name="a_2" type="text" class="field_active" id="a_2" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_1').attr('disabled','disabled');"  value="<?= number_format($angkut->a_2,2); ?>" size="15"/>
          </div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#CCCCFF"><div align="center">
            <input onKeypress="keypress(event)" name="a_3" type="text" class="field_active" id="a_3" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_1').attr('disabled','disabled');"  value="<?= number_format($angkut->a_3,2); ?>" size="15" />
          </div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#FFFFCC"><div align="center">
            <input onKeypress="keypress(event)" name="b_1b" type="text" class="field_active" id="b_1b" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_2').attr('disabled','disabled')"  value="<?= number_format($angkut->b_1b,2); ?>" size="15"/>
          </div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#FFFFCC"><div align="center">
            <input onKeypress="keypress(event)" name="b_1c" type="text" class="field_active" id="b_1c" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_2').attr('disabled','disabled')" value="<?= number_format($angkut->b_1c,2); ?>" size="15"/>
          </div></td>
