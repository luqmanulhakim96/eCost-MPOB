...
$q ="update  estate_info set syarikat ='$syarikat',integrasi = '$integrasi', keahlian='$keahlian', gambut = '$gambut',  percentrata ='$percentrata', percentalun ='$percentalun', percentbukit = '$percentbukit', percentcerun = '$percentcerun' where lesen = '$nolesen' ";
