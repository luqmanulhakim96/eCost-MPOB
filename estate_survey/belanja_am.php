...
<?php if($_SESSION['view']=="true"){ ?><?php echo number_format($emolumen1,2);
	  ?>
<?php } ?>
  	  </td>
    </tr>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>: </strong></td>
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5+$emolumen6+$emolumen7+$emolumen8+$emolumen9+$emolumen10; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5+$emolumen6+$emolumen7+$emolumen8+$emolumen9+$emolumen10; echo number_format($totalemolumen,2);?>
<?php } ?>
	  </strong></td>
    </tr>
	<?php } //emolumen?>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3; echo number_format($totalemolumen,2);?>
<?php } ?>
	  </strong></td>
    </tr>
	<?php }//kosibupejabat?>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>:</strong></td>
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5+$emolumen6; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5+$emolumen6; echo number_format($totalemolumen,2);?>
<?php } ?>
	  </strong></td>
    </tr>
	<?php } //sewa_tol?>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>:</strong></td>
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5+$emolumen6+$emolumen7; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5+$emolumen6+$emolumen7; echo number_format($totalemolumen,2);?>
<?php } ?>
	  </strong></td>
    </tr>
	<?php } // kos agensi ?>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>:</strong></td>
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4; echo number_format($totalemolumen,2);?>
<?php } ?>
	  </strong></td>
    </tr>
	<?php } //penyelenggaraan?>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>:</strong></td>
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5+$emolumen6+$emolumen7+$emolumen8+$emolumen9+$emolumen10+emolumen11; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5+$emolumen6+$emolumen7+$emolumen8+$emolumen9+$emolumen10+emolumen11; echo number_format($totalemolumen,2);?>
<?php } ?>
	  </strong></td>
    </tr>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>:</strong></td>
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1+$emolumen2; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php $totalemolumen = $emolumen1+$emolumen2; echo number_format($totalemolumen,2);?>
<?php } ?>
	  </strong></td>
    </tr>
	<?php } //susutnilai?>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>:</strong></td>
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php $totalemolumen = $emolumen1+$emolumen2+$emolumen3+$emolumen4+$emolumen5; echo number_format($totalemolumen,2);?>
<?php } ?>
	  </strong></td>
    </tr>
	<?php } //kebajikan?>
...
<?php } ?></td>
    ...
    <tr valign="middle">
	  ...
	  <td><strong>:</strong></td>
	  <td><strong>
	    <?php if($_SESSION['view']!="true"){ ?><input name="totalemolumen" type="text" class="field_active" id="totalemolumen" value="<?php $totalemolumen = $emolumen1; echo number_format($totalemolumen,2);?>" size="15" readonly="true" autocomplete="off" />
<?php } ?>
...
<?php } ?>	  </strong></td>
    ...
    <?php if($_SESSION['view']!="true"){ ?>  <input type="submit" name="Submit" value="<?=setstring ( 'mal', 'Simpan', 'en', 'Save'); ?>" onclick="return confirm('<?=setstring ( 'mal', 'Simpan data ini?', 'en', 'Save this data?'); ?>');" />
