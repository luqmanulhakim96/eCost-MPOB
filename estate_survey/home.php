...
<form action="body.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <table width="69%" border="0" cellpadding="1" cellspacing="0" aria-describedby="home">
    <tr>
...
?>
<table width="100%" border="0" cellpadding="0" cellspacing="0"  aria-describedby="home1">
  <tr>
  ...
  <tr>
	...
	<table width="99%" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="table" style="margin-top:5px"  aria-describedby="home3">
      <tr>
