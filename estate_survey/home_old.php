...
<!--<form id="form1" action="home.php?id=home&firsttime" method="post">
-->
  <table width="69%" border="0" cellpadding="1" cellspacing="0">
    <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<?php //if(isset($_GET['welcome'])){ $_SESSION['lesen']=1;}?>
