...
if($sentmail){
				...
				$q_belanja="update belanja_am_kos set status='1' where thisyear='".date('Y')."' and lesen ='".$_SESSION['lesen']."'";
				$r_belanja=mysql_query($q_belanja,$con);
				
				$q_buruh="update buruh_status set status ='1' where tahun='".date('Y')."' and lesen ='".$_SESSION['lesen']."'";
				$r_buruh=mysql_query($q_buruh,$con);
				
				$q_immature="update kos_belum_matang set status ='1' where pb_thisyear='".date('Y')."' and lesen ='".$_SESSION['lesen']."'";
