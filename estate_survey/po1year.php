...
VALUES (
'$year', '".$_COOKIE['tahun_report']."', '".$_SESSION['lesen']."', '".$t."', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0'
);
";
$r=mysqli_query($con, $q);
}
$qk ="delete from kos_belum_matang where pb_tahun='0'";
$rk = mysqli_query($con, $qk);
	...
	if($t=="Penukaran"){
		...
		$con = connect();
		$ttx = $_COOKIE['tahun_report']-2000;

		$tahunsebelum = $ttx-$year;
...
<table width="90%" align="center">
  <tr>
    ...
    Tuan tidak perlu menjawab seksyen ini', 'en', 'Data is unavailable from the e-sub system <br /> You dont have to answer this section'); ?>.</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" cellspacing="0" frame="box" class="subTable" style="margin:3px;">
      <tr>
        ...
        <td height="34" align="right" background="../images/tb_BG.gif" bgcolor="#CC3366"><div align="left" class="style12"><?=setstring ( 'mal', 'Perbelanjaan Tidak Berulang', 'en', 'Non-Recurrent Expenditures'); ?>s</div></td>
      ...
      <tr bgcolor="#99FF99">
        ...
        <td width="163"><div align="center">
          ...
          <?= number_format($nilai->a_1,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?>     <input name="a_1" type="text" class="field_active" id="a_1" value="<?= number_format($nilai->a_1,2); ?>" onchange="kiraan_baru(this,'')" onKeypress="keypress(event)" size="15"/>
<?php } ?>
      ...
      <tr>
        ...
        <td><div align="center">
          ...
          <?= number_format($nilai->a_2,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?><input name="a_2" type="text" class="field_active" id="a_2" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_2,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
      ...
      <tr bgcolor="#99FF99">
        ...
        <td><div align="center">
          ...
          <?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->a_3,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?> <input name="a_3" type="text" class="field_active" id="a_3" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_3,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
      ...
      <tr>
        ...
        <td><div align="center">
          ...
          <?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->a_4,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?><input name="a_4" type="text" class="field_active" id="a_4" onchange="kiraan_baru(this,'')"onclick="field_click(this)" value="<?= number_format($nilai->a_4,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
...
<?php if($_SESSION['view']=="true"){ ?>
          <?= number_format($nilai->a_5,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?><input name="a_5" type="text" class="field_active" id="a_5" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_5,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
      ...
      <tr>
        ...
        <td><div align="center">
          ...
          <?php if($_SESSION['view']=="true"){ ?>
          <?= number_format($nilai->a_6,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?><input name="a_6" type="text" class="field_active" id="a_6" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_6,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
      ...
      <tr bgcolor="#99FF99">
        ...
        <td><div align="center">
          ...
          <?php if($_SESSION['view']=="true"){ ?>
          <?= number_format($nilai->a_7,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?><input name="a_7" type="text" class="field_active" id="a_7" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_7,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
...
<?php if($_SESSION['view']=="true"){ ?>
          <?= number_format($nilai->a_8,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?><input name="a_8" type="text" class="field_active" id="a_8" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_8,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
      ...
      <tr bgcolor="#99FF99">
        ...
        <td><div align="center">
          ...
          <?php if($_SESSION['view']=="true"){ ?>
          <?= number_format($nilai->a_9,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?><input name="a_9" type="text" class="field_active" id="a_9" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_9,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
...
<?php if($_SESSION['view']=="true"){ ?>
          <?= number_format($nilai->a_10,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?> <input name="a_10" type="text" class="field_active" id="a_10" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_10,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
      ...
      <tr bgcolor="#99FF99">
        ...
        <td><div align="center">
          ...
          <?php if($_SESSION['view']=="true"){ ?>
          <?= number_format($nilai->a_11,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?>  <input name="a_11" type="text" class="field_active" id="a_11" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->a_11,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
        </div></td>
        <td><div align="center">
...
<?php if($_SESSION['view']=="true"){ ?>
            <?= number_format($nilai->total_a,2); ?>
<?php } ?>

<?php if($_SESSION['view']!="true"){ ?>    <input name="total_kos_a" type="text" id="total_kos_a"  style="font-weight:bold; text-align:center" value="<?= number_format($nilai->total_a,2); ?>" size="15" readonly="true" />
<?php } ?>
          </div>          </td>
...
<?php if($_SESSION['view']!="true"){ ?>  <input name="total_b_1" type="text" class="field_active" id="total_b_1"  style="font-weight:bold; text-align:center" onchange="kiraan_baru(this,'')" onblur="$('#b_1a,#b_1b,#b_1c').attr('disabled','disabled')" value="<?php
...
<?php if($_SESSION['view']!="true"){ ?>   <input name="b_1a" type="text" class="field_active" id="b_1a" onblur="$('#total_b_1').attr('disabled','disabled')" value="<?= number_format($nilai->b_1a,2); ?>" size="15" onKeypress="keypress(event)" onchange="kiraan_baru(this,'anak')" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->b_1a,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?> <input name="b_1b" type="text" class="field_active" id="b_1b"  onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_1').attr('disabled','disabled')" value="<?= number_format($nilai->b_1b,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->b_1b,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>        <input name="b_1c" type="text" class="field_active" id="b_1c" onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_1').attr('disabled','disabled')" value="<?= number_format($nilai->b_1c,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->b_1c,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>  <input name="total_b_2" type="text" class="field_active" id="total_b_2"  onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_2,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_2,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?> <input name="total_b_3" type="text" class="field_active" id="total_b_3"  style="font-weight:bold; text-align:center" value="<?php
...
<?php if($_SESSION['view']!="true"){ ?><input name="b_3a" type="text" class="field_active" id="b_3a"  onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_3').attr('disabled','disabled')" onfocus="$('#total_b_3').attr('disabled','disabled')" value="<?= number_format($nilai->b_3a,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->b_3a,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>  <input name="b_3b" type="text" class="field_active" id="b_3b"  onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_3').attr('disabled','disabled')" onfocus="$('#total_b_3').attr('disabled','disabled')" value="<?= number_format($nilai->b_3b,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->b_3b,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>   <input name="b_3c" type="text" class="field_active" id="b_3c"  onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_3').attr('disabled','disabled')" onfocus="$('#total_b_3').attr('disabled','disabled')" value="<?= number_format($nilai->b_3c,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->b_3c,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>   <input name="b_3d" type="text" class="field_active" id="b_3d"  onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_3').attr('disabled','disabled')" onfocus="$('#total_b_3').attr('disabled','disabled')" value="<?= number_format($nilai->b_3d,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->b_3d,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?><input name="total_b_4" type="text" class="field_active" id="total_b_4" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_4,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_4,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?><input name="total_b_5" type="text" class="field_active" id="total_b_5"  onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_5,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_5,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?><input name="total_b_6" type="text" class="field_active" id="total_b_6" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_6,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_6,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>     <input name="total_b_7" type="text" class="field_active" id="total_b_7" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_7,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_7,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>   <input name="total_b_8" type="text" class="field_active" id="total_b_8" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_8,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_8,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?> <input name="total_b_9" type="text" class="field_active" id="total_b_9" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_9,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_9,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?> <input name="total_b_10" type="text" class="field_active" id="total_b_10" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_10,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_10,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>       <input name="total_b_11" type="text" class="field_active" id="total_b_11" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_11,2); ?>" onKeypress="keypress(event)" size="15" tabindex="1" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_11,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?><input name="total_b_12" type="text" class="field_active" id="total_b_12" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_12,2); ?>" onKeypress="keypress(event)" size="15" tabindex="2" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_12,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>  <input name="total_b_13" type="text" class="field_active" id="total_b_13" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_13,2); ?>" onKeypress="keypress(event)" size="15" tabindex="3" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_13,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?> <input name="total_b_14" type="text" class="field_active" id="total_b_14" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_14,2); ?>" onKeypress="keypress(event)" size="15" tabindex="4" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b_14,2); ?>
<?php } ?>
...
<?php if($_SESSION['view']!="true"){ ?>       <input name="total_kos_b" type="text" id="total_kos_b" style="font-weight:bold; text-align:center" value="<?= number_format($nilai->total_b,2); ?>" size="15" readonly="true" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($nilai->total_b,2); ?>
<?php } ?>
  ...
  <tr>
    ...
    <?php if($_SESSION['view']!="true"){ ?><input type="button" name="simpan_sementara" id="simpan_sementara" value=<?=setstring ( 'mal', '"Simpan Sementara"', 'en', '"Save Temporarily"'); ?> onclick="hantar(2);" />
