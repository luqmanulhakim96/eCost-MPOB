...
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
    ...
    <?php if($_SESSION['view']!="true"){ ?>  <input name="total_b_1" type="text" id="total_b_1" class="field_active"  style="font-weight:bold; text-align:center" value="<?php
  ...
  else
  {
    ...
    ?>" size="15" onchange="kiraan_baru(this,'')" onKeypress="keypress(event)" onblur="$('#b_1a, #b_1b, #b_1c').attr('disabled','disabled')"/>
<?php } ?>
...
<?php } ?>
      ...
      <tr>
        ...
        <td bgcolor="#CCCCFF"><div align="center">
          ...
          <?php if($_SESSION['view']!="true"){ ?>   <input name="b_1a" type="text" class="field_active" id="b_1a" onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_1').attr('disabled','disabled')" value="<?= number_format($nilai->b_1a,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>
...
<?php } ?>
      ...
      <tr>
        ...
        <td><div align="center" class="style10"><span class="style6">
           ...
           <?php if($_SESSION['view']!="true"){ ?>  <input name="total_b_3" type="text" id="total_b_3" class="field_active" onKeypress="keypress(event)" style="font-weight:bold; text-align:center" value="<?php
...
<?php } ?>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          ...
          <?php if($_SESSION['view']!="true"){ ?>          <input name="b_3a" type="text" class="field_active" id="b_3a" onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_3').attr('disabled','disabled')" value="<?= number_format($nilai->b_3a,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>
...
<?php } ?>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          ...
          <?php if($_SESSION['view']!="true"){ ?> <input name="b_3b" type="text" class="field_active" id="b_3b" onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_3').attr('disabled','disabled')" value="<?= number_format($nilai->b_3b,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>
...
<?php } ?>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          ...
          <?php if($_SESSION['view']!="true"){ ?>  <input name="b_3c" type="text" class="field_active" id="b_3c" onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_3').attr('disabled','disabled')" value="<?= number_format($nilai->b_3c,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>
...
<?php } ?>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          ...
          <?php if($_SESSION['view']!="true"){ ?> <input name="b_3d" type="text" class="field_active" id="b_3d" onchange="kiraan_baru(this,'anak')" onblur="$('#total_b_3').attr('disabled','disabled')" value="<?= number_format($nilai->b_3d,2); ?>" onKeypress="keypress(event)" size="15" />
<?php } ?>
...
<?php } ?>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center">
          ...
          <?php if($_SESSION['view']!="true"){ ?>    <input name="total_b_11" type="text" class="field_active" id="total_b_11" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_11,2); ?>" onKeypress="keypress(event)" size="15"/>
...
<?php } ?>
      ...
      <tr>
        ...
        <td bgcolor="#99FF99"><div align="center">
          ...
          <?php if($_SESSION['view']!="true"){ ?><input name="total_b_12" type="text" class="field_active" id="total_b_12" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_12,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
...
<?php } ?>
      ...
      <tr>
        ...
        <td><div align="center">
          ...
          <?php if($_SESSION['view']!="true"){ ?> <input name="total_b_13" type="text" class="field_active" id="total_b_13" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_13,2); ?>" onKeypress="keypress(event)" size="15"/>
<?php } ?>
...
<?php } ?>
  ...
  <tr>
    ...
    <td bgcolor="#CC6699"><div align="center"><strong><span id="total_all"><?php $total_all = $nilai->total_b;?></span></strong><strong><span class="style6">
      ...
      <?php if($_SESSION['view']!="true"){ ?> <input name="total_kos_b" type="text" id="total_kos_b" onKeypress="keypress(event)" style="font-weight:bold; text-align:center" value="<?= number_format($nilai->total_b,2); ?>" size="15" readonly="true" />
<?php } ?>
...
<?php
        ...
        <input type="button" name="simpan" id="simpan" value=<?=setstring ('mal','"Simpan &amp; Sahkan"' ,'en','"Save &amp; Verify"')?> onclick="pitmid = true; hantar(1);" />
        <?php
			}
			?>
      </div>
