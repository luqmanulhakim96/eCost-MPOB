...
<table width="90%" align="center" class="tableCss">
  ...
  <tr>
    <td colspan="5" class="style55"><strong><?=setstring ( 'mal', '(DITANAM PADA TAHUN', 'en', '(PLANTED ON'); ?> <span class="style2"><?php $tahun = $_SESSION['tahun'];
  ...
  <tr>
   ...
   <?php if($_SESSION['view']!="true"){ ?>   <input onKeypress="keypress(event)" name="jumlah2" type="text" id="jumlah2" style="background-color:#FFFF99; font-weight:bold" onchange="gonext(this.value,<?= $umur->tahun_tanam[$j]; ?>,'edit')" value="<?= $up; ?>" />
     <a href="#"><img src="../images/tidak_matang.png" width="20" height="20" border="0" onclick="gonext('',<?= $umur->tahun_tanam[$j]; ?>,'delete')" /></a>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= $up; ?>
<?php } ?>
     ...
     <?php if($_SESSION['view']!="true"){ ?>      <tr valign="top">
...
<?php } ?>
	  ...
	  <tr valign="top">
        ...
        <td>
        <?php if($_SESSION['view']!="true"){ ?>        <input onKeypress="keypress(event)" name="totalj" type="text" id="totalj" style="background-color:#FFCC66; font-weight:bold" value="<?= $total_umur;  ?>" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= $total_umur;  ?>
<?php } ?>
  ...
  <tr>
    <td colspan="5">
	<table width="100%" cellpadding="0" cellspacing="0"  frame="box" class="subTable">
      <tr>
      ...
      <tr bgcolor="#AEFFAE">
        ...
        <?php if($_SESSION['view']!="true"){ ?><input onKeypress="keypress(event)" name="total_b_1" type="text" id="total_b_1"  style="font-weight:bold; text-align:center" value="<?= number_format($jaga->total_b_1,2); ?>" size="20" class="field_active" onchange="kiraan_baru(this,'a');$('#b_1a, #b_1b, #b_1c').attr('disabled','disabled')" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_1,2); ?>
<?php } ?>
      ...
      <tr>
        ...
        <td bgcolor="#CCCCFF"><div align="center">
             <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="b_1a" type="text" class="field_active" id="b_1a" onchange="kiraan_baru(this,'anak');$('#total_b_1').attr('disabled','disabled');"  value="<?= number_format($jaga->b_1a,2); ?>" size="15" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->b_1a,2); ?>
<?php } ?>  </div></td>
 
        <td bgcolor="#CCCCFF"><div align="center"><span id="s1"><?php $x1 = ($jaga->b_1a/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#CCCCFF"><div align="center"><span id="s1a_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#CCCCFF"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="b_1b" type="text" class="field_active" id="b_1b" onchange="kiraan_baru(this,'anak');$('#total_b_1').attr('disabled','disabled')" value="<?= number_format($jaga->b_1b,2); ?>" size="15" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->b_1b,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#CCCCFF"><div align="center"><span id="s2"><?php $x1 = ($jaga->b_1b/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#CCCCFF"><div align="center"><span id="s2a_tan">
          <?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?>
        </span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#CCCCFF"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="b_1c" type="text" class="field_active" id="b_1c" onchange="kiraan_baru(this,'anak');$('#total_b_1').attr('disabled','disabled')"  value="<?= number_format($jaga->b_1c,2); ?>" size="15" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->b_1c,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#CCCCFF"><div align="center"><span id="s3"><?php $x1 = ($jaga->b_1c/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#CCCCFF"><div align="center"><span id="s3a_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#AEFFAE"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_2" type="text" class="field_active" id="total_b_2" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_2,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_2,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="jaga2"><?php $x1 = ($jaga->total_b_2/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="s2_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr bgcolor="#AEFFAE">
		...
		?>
          ...
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_3" type="text" id="total_b_3"  style="font-weight:bold; text-align:center" value="<?= number_format($jaga->total_b_3,2); ?>" size="20" class="field_active" onchange="kiraan_baru(this,'b');$('#b_3a, #b_3b, #b_3c, #b_3d').attr('disabled','disabled')" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_3,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="jaga3"><?php $x1 = ($jaga->total_b_3/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="s3_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="b_3a" type="text" class="field_active" id="b_3a" onchange="kiraan_baru(this,'anak');$('#total_b_3').attr('disabled','disabled');"  value="<?= number_format($jaga->b_3a,2); ?>" size="15" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->b_3a,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFCC"><div align="center"><span id="s6"><?php $x1 = ($jaga->b_3a/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFCC"><div align="center"><span id="s6a_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="b_3b" type="text" class="field_active" id="b_3b" onchange="kiraan_baru(this,'anak');$('#total_b_3').attr('disabled','disabled');"  value="<?= number_format($jaga->b_3b,2); ?>" size="15" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->b_3b,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFCC"><div align="center"><span id="s7"><?php $x1 = ($jaga->b_3b/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFCC"><div align="center"><span id="s7a_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="b_3c" type="text" class="field_active" id="b_3c" onchange="kiraan_baru(this,'anak');$('#total_b_3').attr('disabled','disabled')"  value="<?= number_format($jaga->b_3c,2); ?>" size="15" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->b_3c,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFCC"><div align="center"><span id="s8"><?php $x1 = ($jaga->b_3c/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFCC"><div align="center"><span id="s8a_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFCC"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="b_3d" type="text" class="field_active" id="b_3d" onchange="kiraan_baru(this,'anak');$('#total_b_3').attr('disabled','disabled');"  value="<?= number_format($jaga->b_3d,2); ?>" size="15" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->b_3d,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFCC"><div align="center"><span id="s9"><?php $x1 = ($jaga->b_3d/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFCC"><div align="center"><span id="s9a_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr bgcolor="#AEFFAE">
        ...
        <td bgcolor="#AEFFAE"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_4" type="text" class="field_active" id="total_b_4" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_4,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_4,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="jaga4"><?php $x1 = ($jaga->total_b_4/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="s4_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_5" type="text" class="field_active" id="total_b_5" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_5,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_5,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="jaga5"><?php $x1 = ($jaga->total_b_5/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="s5_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr bgcolor="#AEFFAE">
        ...
        <td bgcolor="#AEFFAE"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_6" type="text" class="field_active" id="total_b_6" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_6,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_6,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="jaga6"><?php $x1 = ($jaga->total_b_6/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="s6_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_7" type="text" class="field_active" id="total_b_7" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_7,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_7,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="jaga7"><?php $x1 = ($jaga->total_b_7/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="s7_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr bgcolor="#AEFFAE">
        ...
        <td bgcolor="#AEFFAE"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_8" type="text" class="field_active" id="total_b_8" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_8,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_8,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="jaga8"><?php $x1 = ($jaga->total_b_8/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="s8_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_9" type="text" class="field_active" id="total_b_9" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_9,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_9,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="jaga9"><?php $x1 = ($jaga->total_b_9/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="s9_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr bgcolor="#AEFFAE">
        ...
        <td bgcolor="#AEFFAE"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_10" type="text" class="field_active" id="total_b_10" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_10,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_10,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="jaga10"><?php $x1 = ($jaga->total_b_10/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="s10_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_11" type="text" class="field_active" id="total_b_11" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_11,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_11,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="jaga11"><?php $x1 = ($jaga->total_b_11/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><span id="s11_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
      ...
      <tr bgcolor="#AEFFAE">
        ...
        <td bgcolor="#AEFFAE"><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input onKeypress="keypress(event)" name="total_b_12" type="text" class="field_active" id="total_b_12" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($jaga->total_b_12,2); ?>" size="20" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b_12,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="jaga12"><?php $x1 = ($jaga->total_b_12/$b); echo number_format($x1,2);?></span></div></td>
        <td bgcolor="#AEFFAE"><div align="center"><span id="s12_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
    ...
    <?php if($_SESSION['view']!="true"){ ?>	<input onKeypress="keypress(event)" name="total_a" type="text" id="total_a"  style="font-weight:bold; text-align:center" value="<?= number_format($jaga->total_b,2); ?>" size="20" readonly="true" />

<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($jaga->total_b,2); ?>
<?php } ?>
        </strong></div></td>
        <td bgcolor="#FFCC66"><div align="center"><strong>
          <span id="total_a_perha"><?php $x1a = ($jaga->total_b/$b); echo number_format($x1a,2);?></span>
        </strong></div></td>
        <td bgcolor="#FFCC66"><div align="center"><strong>
          <span id="total_a_pertan"><?php $y1a = ($x1a/$tan_ha); echo number_format($y1a,2);?></span>
        </strong></div></td>
        <td bgcolor="#FFCC66"><div align="center"><strong>
      ...
      <tr>
        <td height="32" colspan="6" align="center"><div align="center">
          <input onKeypress="keypress(event)" name="thisyear" type="hidden" id="thisyear" value="<?= date('Y'); ?>" />
          ...
          <input type="button" name="simpan_sementara3" id="simpan_sementara3" value=<?=setstring ( 'mal', '"Simpan Sementara"', 'en', '"Save Temporarily"'); ?>
 onclick="hantar(2);" />
          <input type="button" name="simpan" id="simpan" value=<?=setstring ( 'mal', '"Simpan &amp; Sahkan"', 'en', '"Save &amp; Verify"'); ?>
  ...
  <tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0"  frame="box" class="subTable">
        <tr>
          ...
          <td background="../images/tb_BG.gif" class="tableCss"><div align="center"><b><?=setstring ( 'mal', 'Kos', 'en', 'Cost'); ?>
</b></div>            <div align="center"><b>&nbsp;(RM)</b></div></td>
        ...
        <tr>
          ...
          <td width="141" bgcolor="#AEFFAE"><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?><input onKeypress="keypress(event)" name="a_1" type="text" class="field_active" id="a_1" onchange="kiraan_baru_tuai(this)" onclick="field_click(this)" value="<?= number_format($tuai->a_1,2); ?>" size="20" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($tuai->a_1,2); ?>
<?php } ?>
          </div></td>
          <td width="119" bgcolor="#AEFFAE"><div align="center"><span id="t1"><?php $x1 = ($tuai->a_1/$b); echo number_format($x1,2);?></span></div></td>
          <td width="116" bgcolor="#AEFFAE"><div align="center"><span id="t1_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?><input onKeypress="keypress(event)" name="a_2" type="text" class="field_active" id="a_2"  onchange="kiraan_baru_tuai(this)" onclick="field_click(this)" value="<?= number_format($tuai->a_2,2); ?>" size="20" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($tuai->a_2,2); ?>
<?php } ?>
          </div></td>
          <td><div align="center"><span id="t2"><?php $x1 = ($tuai->a_2/$b); echo number_format($x1,2);?></span></div></td>
          <td><div align="center"><span id="t2_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td bgcolor="#AEFFAE"><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?>     <input onKeypress="keypress(event)" name="a_3" type="text" class="field_active" id="a_3"  onchange="kiraan_baru_tuai(this)" onclick="field_click(this)" value="<?= number_format($tuai->a_3,2); ?>" size="20"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($tuai->a_3,2); ?>
<?php } ?>
          </div></td>
          <td bgcolor="#AEFFAE"><div align="center"><span id="t3"><?php $x1 = ($tuai->a_3/$b); echo number_format($x1,2);?></span></div></td>
          <td bgcolor="#AEFFAE"><div align="center"><span id="t3_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?><input onKeypress="keypress(event)" name="a_4" type="text" class="field_active" id="a_4" onchange="kiraan_baru_tuai(this)" onclick="field_click(this)" value="<?= number_format($tuai->a_4,2); ?>" size="20" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($tuai->a_4,2); ?>
<?php } ?>
          </div></td>
          <td><div align="center"><span id="t4"><?php $x1 = ($tuai->a_4/$b); echo number_format($x1,2);?></span></div></td>
          <td><div align="center"><span id="t4_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
 ...
 (b) :</strong></div></td>
          <td bgcolor="#FFCC66"><div align="center"><strong> <!--<span id="total_a_tuai">0.00</span>-->
          
        
          <?php if($_SESSION['view']!="true"){ ?>  <input onKeypress="keypress(event)" name="total_b" type="text" id="total_b"  style="font-weight:bold; text-align:center" value="<?= number_format($tuai->total_b,2); ?>" size="20" readonly="true" /> 
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($tuai->total_b,2); ?>
<?php } ?>
        ...
        <tr>
		  ...
		  ?>
            ...
            <?php if($_SESSION['view']!="true"){ ?> <input onKeypress="keypress(event)" type="button" name="simpan_sementara2" id="simpan_sementara2" value=<?=setstring ( 'mal', '"Simpan Sementara"', 'en', '"Save Temporarily"'); ?>
 onclick="hantar_a(2);" />
            <input onKeypress="keypress(event)" type="button" name="simpan2" id="simpan2" value=<?=setstring ( 'mal', '"Simpan &amp; Sahkan"', 'en', '"Save &amp; Verify"'); ?>
...
<?php } ?>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0"  frame="box" class="subTable">
        <tr>
          <td height="47" align="center" valign="middle" background="../images/tb_BG.gif"><strong>c.</strong></td>
          <td colspan="2" valign="middle" background="../images/tb_BG.gif"><b><?=setstring ( 'mal', 'Pengangkutan BTS', 'en', 'Transportation of FFB'); ?>
</b></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#AEFFAE"><div align="center"><strong>
            ...
            <?php if($_SESSION['view']!="true"){ ?>  <input onKeypress="keypress(event)" name="total_b_1" type="text" id="total_b_1"  style="font-weight:bold; text-align:center" value="<?php 
			if($angkut->total_a==0){
...
<?php } ?>
          ...
          <td valign="middle" bgcolor="#AEFFAE"><div align="center"><span id="s1_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
...
:</td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#CCCCFF"><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?>      <input onKeypress="keypress(event)" name="a_1" type="text" class="field_active" id="a_1" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_1').attr('disabled','disabled');" value="<?= number_format($angkut->a_1,2); ?>" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($angkut->a_1,2); ?>
<?php } ?>


          </div></td>
          <td valign="middle" bgcolor="#CCCCFF"><div align="center"><span id="a1"><?php $x1 = ($angkut->a_1/$b); echo number_format($x1,2);?></span></div></td>
          <td valign="middle" bgcolor="#CCCCFF"><div align="center"><span id="a1_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#CCCCFF"><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?>   <input onKeypress="keypress(event)" name="a_2" type="text" class="field_active" id="a_2" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_1').attr('disabled','disabled');"  value="<?= number_format($angkut->a_2,2); ?>" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($angkut->a_2,2); ?>
<?php } ?>


          </div></td>
          <td valign="middle" bgcolor="#CCCCFF"><div align="center"><span id="a2"><?php $x1 = ($angkut->a_2/$b); echo number_format($x1,2);?></span></div></td>
          <td valign="middle" bgcolor="#CCCCFF"><div align="center"><span id="a2_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#CCCCFF"><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?>       <input onKeypress="keypress(event)" name="a_3" type="text" class="field_active" id="a_3" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_1').attr('disabled','disabled');"  value="<?= number_format($angkut->a_3,2); ?>" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($angkut->a_3,2); ?>
<?php } ?>


          </div></td>
          <td valign="middle" bgcolor="#CCCCFF"><div align="center"><span id="a3"><?php $x1 = ($angkut->a_3/$b); echo number_format($x1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td valign="middle"><div align="center"><strong>
           ...
           <?php if($_SESSION['view']!="true"){ ?> <input onKeypress="keypress(event)" name="total_b_2" type="text" id="total_b_2"  style="font-weight:bold; text-align:center" value="<?php 
...
<?php } ?>
        ...
        <tr>
          ...
          <td colspan="2" valign="middle" bgcolor="#FFFFCC">i. <?=setstring ( 'mal', 'Pengangkutan BTS ke kilang', 'en', 'Mainline transportation cost from platform to loading centre or mill'); ?></td>
          <td valign="middle" bgcolor="#FFFFCC"><div align="center">
         
            
            <?php if($_SESSION['view']!="true"){ ?>
               <input onKeypress="keypress(event)" name="b_1a" type="text" class="field_active" id="b_1a" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_2').attr('disabled','disabled')" value="<?= number_format($angkut->b_1a,2); ?>" size="15" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($angkut->b_1a,2); ?>
<?php } ?>
            
          </div></td>
          <td valign="middle" bgcolor="#FFFFCC"><div align="center"><span id="a4">
            <?php $x1 = ($angkut->b_1a/$b); echo number_format($x1,2);?>
          </span></div></td>
          <td valign="middle" bgcolor="#FFFFCC"><div align="center"><span id="a4_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#FFFFCC"><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?>            <input onKeypress="keypress(event)" name="b_1b" type="text" class="field_active" id="b_1b" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_2').attr('disabled','disabled')"  value="<?= number_format($angkut->b_1b,2); ?>" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($angkut->b_1b,2); ?>
<?php } ?>
          </div></td>
          <td valign="middle" bgcolor="#FFFFCC"><div align="center"><span id="a5"><?php $x1 = ($angkut->b_1b/$b); echo number_format($x1,2);?></span></div></td>
          <td valign="middle" bgcolor="#FFFFCC"><div align="center"><span id="a5_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#FFFFCC"><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?>    <input onKeypress="keypress(event)" name="b_1c" type="text" class="field_active" id="b_1c" onchange="kiraan_baru_angkut(this,'anak');$('#total_b_2').attr('disabled','disabled')" value="<?= number_format($angkut->b_1c,2); ?>" size="15"/>
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($angkut->b_1c,2); ?>
<?php } ?>
            
          </div></td>
          <td valign="middle" bgcolor="#FFFFCC"><div align="center"><span id="a6"><?php $x1 = ($angkut->b_1c/$b); echo number_format($x1,2);?></span></div></td>
          <td valign="middle" bgcolor="#FFFFCC"><div align="center"><span id="a6_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#AEFFAE"><div align="center">
            ...
            <?php if($_SESSION['view']!="true"){ ?>  <input onKeypress="keypress(event)" name="total_b_3" type="text" class="field_active" id="total_b_3" onchange="kiraan_baru_angkut(this,'')" onclick="field_click(this)" value="<?= number_format($angkut->total_b_2,2); ?>" size="20"/>
            
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($angkut->total_b_2,2); ?>
<?php } ?>

          </div></td>
          <td valign="middle" bgcolor="#AEFFAE"><div align="center"><span id="jaga3"><?php $x1 = ($angkut->total_b_2/$b); echo number_format($x1,2);?></span></div></td>
          <td valign="middle" bgcolor="#AEFFAE"><div align="center"><span id="s3_tan"><?php $y1 = ($x1/$tan_ha); echo number_format($y1,2);?></span></div></td>
 ...
 (c) : </strong></div></td>
          <td valign="middle" bgcolor="#FFCC66"><div align="center"><strong>
            ...
            <?php if($_SESSION['view']!="true"){ ?>    <input onKeypress="keypress(event)" name="total_a" type="text" id="total_a"  style="font-weight:bold; text-align:center" value="<?= number_format($angkut->total_b,2); ?>" size="20" readonly="true" />
            
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?= number_format($angkut->total_b,2); ?>
<?php } ?>

          </strong></div></td>
          <td valign="middle" bgcolor="#FFCC66"><div align="center"><strong> <span id="total_a_perha"><?php $x1c = ($angkut->total_b/$b); echo number_format($x1c,2);?></span> </strong></div></td>
          <td valign="middle" bgcolor="#FFCC66"><div align="center"><strong> <span id="total_a_pertan"><?php $y1c = ($x1c/$tan_ha); echo number_format($y1c,2);?></span> </strong></div></td>
...
<?php } ?>
		  ...
		  // $total_all_bts = $y1a+$y1b+$y1c; 
		   echo number_format($total_all_bts,2);?></span></strong>
        ...
        <tr>
          ...
          <?php if($_SESSION['view']!="true"){ ?>
                     <input type="button" name="simpan_sementara22" id="simpan_sementara22" value="<?=setstring ( 'mal', 'Simpan Sementara', 'en', 'Save Temporarily'); ?>" onclick="document.form3.action = 'save_kos_matang.php?status=2';document.form3.target = '_parent';document.form3.submit();" />
            <input type="button" name="simpan22" id="simpan22" value="<?=setstring ( 'mal', 'Simpan &amp; Sahkan', 'en', 'Save &amp; Verify'); ?>" onclick="pitmid = true; document.form3.action = 'save_kos_matang.php?status=1';document.form3.target = '_parent';document.form3.submit();;" />
<?php } ?>
