...
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
   ...
   <?php if($_SESSION['view']!="true"){ ?><input name="total_b_1" type="text" id="total_b_1"  style="font-weight:bold; text-align:center" value="<?php
...
<?php } ?>
      ...
      <tr>
        ...
        <td><div align="center" class="style10"><span class="style6">
          ...
          <?php if($_SESSION['view']!="true"){ ?>          <input name="total_b_3" type="text" id="total_b_3"  style="font-weight:bold; text-align:center" value="<?php
...
<?php if($_SESSION['view']=="true"){ ?>
<?= number_format($nilai->total_b_9,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#FFFFFF"><div align="center">
...
<?php if($_SESSION['view']=="true"){ ?>
<?= number_format($nilai->total_b_10,2); ?>
<?php } ?>
        </div></td>
        <td bgcolor="#99FF99"><div align="center">
...
<?php } ?>
      ...
      <tr bgcolor="#99FF99">
        ...
        <td align="right"><div align="left"><?=setstring ( 'mal', 'Perbelanjaan pelbagai', 'en', 'Other Expenditures'); ?>i</div></td>
        <td><div align="center">
          <?php if($_SESSION['view']!="true"){ ?>          <input name="total_b_14" type="text" class="field_active" id="total_b_14" onchange="kiraan_baru(this,'')" onclick="field_click(this)" value="<?= number_format($nilai->total_b_14,2); ?>" onKeypress="keypress(event)" size="15"/>
...
<?php } ?>
  ...
  <tr>
    ...
    <td bgcolor="#CC6699"><div align="center"><strong><span id="total_all"><?php $total_all = $nilai->total_b;?></span></strong><strong><span class="style6">
      ...
      <?php if($_SESSION['view']!="true"){ ?> <input name="total_kos_b" type="text" id="total_kos_b"  style="font-weight:bold; text-align:center" value="<?= number_format($nilai->total_b,2); ?>" size="15" readonly="true" onKeypress="keypress(event)" />
<?php } ?>
...
<?php } ?>
    ...
    <td bgcolor="#CC6699"><div align="center"><strong><span id="total_all_per_ha"><?php $kph = (($total_all)/($data)); echo number_format($kph,2); ?></span></strong>
      <input name="total_b" type="hidden" id="total_b" />
    </div></td>
  </tr>
  <tr>
    <td colspan="4"><br /></td>
