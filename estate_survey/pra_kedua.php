...
<table class="tableCss" align="left">
  ...
  <tr>
    ...
    <td colspan="4"><table width="80%" frame="box" class="subTable">
      <tr>
        ...
        <td width="144"><input name="txtCa13" type="text" onblur="kiraTotal(this.value,'txtCa25')" onkeyup="kira('31','32','txtCa25','txtCa1',this.value)" value="0" size="15" onKeypress="keypress(event)"/></td>
        <td width="144"><input name="txtCa25" type="text" id="txtCa25" value="0" size="10" onKeypress="keypress(event)" /></td>
        <td width="144"><input name="txtCa1" type="text" id="txtCa1" value="0" size="10" onKeypress="keypress(event)" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="txtCa16" type="text" onblur="kiraTotal(this.value,'txtCa28')" onkeyup="kira('31','32','txtCa28','txtCa4',this.value)" value="0" size="15" onKeypress="keypress(event)"/></td>
        <td><input name="txtCa28" type="text" id="txtCa28" value="0" size="10" onKeypress="keypress(event)"/></td>
        <td><input name="txtCa4" type="text" id="txtCa4" value="0" size="10" onKeypress="keypress(event)"/></td>
      </tr>
      <tr>
        <td align="center">5.</td>
        <td>Pemuliharan tanah/air&nbsp;[<i>Soil/water conservation</i>]</td>
        <td><input name="txtCa17" type="text" value="0" size="15" onKeypress="keypress(event)"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa18" type="text" value="0" size="15" onKeypress="keypress(event)"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa19" type="text" value="0" size="15" onKeypress="keypress(event)"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa20" type="text" value="0" size="15" onKeypress="keypress(event)"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa21" type="text" value="0" size="15" onKeypress="keypress(event)"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa22" type="text" value="0" size="15" onKeypress="keypress(event)"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa23" type="text" value="0" size="15" onKeypress="keypress(event)"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa24" type="text" value="0" size="15" onKeypress="keypress(event)"/></td>
  ...
  <tr>
    ...
    <td colspan="4"><table width="80%" frame="box" class="subTable">
      <tr>
        ...
        <td width="253"><input name="txtCb1" type="text" value="0" onKeypress="keypress(event)" /></td>
      </tr>
      <tr>
        <td align="right">2.</td>
  ...
  <tr>
    ...
    <input type="reset" name="button2" id="button2" value="   Cetak   " /></td>
  </tr>
</table>
</form>
