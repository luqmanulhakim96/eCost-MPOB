...
?>
<link rel="stylesheet" href="colorbox.css" type="text/css" />s
<script type="text/javascript" src="colorbox/jquery.colorbox.js"></script>
<?php
	}
...
<div id="errorDialog">
	<p>
    	<img src="../images/001_30.gif" width="24" height="24" alt="Ralat" />&nbsp;<?=setstring ( 'mal', 'Anda Perlu Login Sebelum Menggunakan Sistem!', 'en', 'You have to Login to use the System!'); ?></p>
</div>
<div id="loginDialog">
  ...
  <table width="49%" border="0" cellpadding="1" cellspacing="0">
    ...
    <tr>
      <td colspan="3"><p><strong>En. Azman Ismail - 03-78022880</strong><br />
        Email : azman@mpob.gov.my</p>
          <p><strong>Jusoh Latif - 03 78022934</strong><br />
            Email : jusoh@mpob.gov.my</p>
        <p><strong>Norhazifah Suhani - 03  78022866</strong><br />
          Email : zifah@mpob.gov.my</p>
