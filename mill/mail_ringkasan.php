...
$title.=$row['No_Lesen_Baru'].' '.$row['Nama_Estet'];
				...
				$q_belanja="update mill_buruh set status='1' where tahun='".$_SESSION['tahun']."' and lesen ='".$_SESSION['lesen']."'";
				$r_belanja=mysqli_query($con, $q_belanja);

				$q_buruh="update mill_kos_lain set status ='1' where tahun='".$_SESSION['tahun']."' and lesen ='".$_SESSION['lesen']."'";
				$r_buruh=mysqli_query($con, $q_buruh);

				$q_immature="update mill_pemprosesan set status ='1' where tahun='".$_SESSION['tahun']."' and lesen ='".$_SESSION['lesen']."'";
