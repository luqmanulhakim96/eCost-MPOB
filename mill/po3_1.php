...
<table class="tableCss" align="left">
  ...
  <tr>
    ...
    <td colspan="2"><b>Keluasan keluasan kawasan matang </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input name="txtArea" type="text" value="10292" />
      &nbsp;Hektar </td>
  </tr>
  <tr>
    <td height="20px"></td>
  ...
  <tr>
    ...
    <td colspan="2"><table width="80%"  frame="box" class="subTable">
      ...
      <tr>
        ...
        <td><input name="txtCa13" type="text" value="2345" /></td>
        <td width="183"><input name="txtCa1" type="text" value="453" /></td>
        <td><input name="txtCa25" type="text" value="123" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">Februari </div></td>
        <td><input name="txtCa14" type="text" value="754" /></td>
        <td><input name="txtCa2" type="text" value="234" /></td>
        <td><input name="txtCa26" type="text" value="123" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">Mac</div></td>
        <td><input name="txtCa15" type="text" value="785" /></td>
        <td><input name="txtCa3" type="text" value="567" /></td>
        <td><input name="txtCa27" type="text" value="231" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">April </div></td>
        <td><input name="txtCa16" type="text" value="465" /></td>
        <td><input name="txtCa4" type="text" value="123" /></td>
        <td><input name="txtCa28" type="text" value="127" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">Mei </div></td>
        <td><input name="txtCa17" type="text" value="896" /></td>
        <td><input name="txtCa5" type="text" value="768" /></td>
        <td><input name="txtCa29" type="text" value="126" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">Jun </div></td>
        <td><input name="txtCa18" type="text" value="234" /></td>
        <td><input name="txtCa6" type="text" value="234" /></td>
        <td><input name="txtCa30" type="text" value="143" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">Julai </div></td>
        <td><input name="txtCa19" type="text" value="876" /></td>
        <td><input name="txtCa7" type="text" value="324" /></td>
        <td><input name="txtCa31" type="text" value="156" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">Ogos</div></td>
        <td><input name="txtCa20" type="text" value="324" /></td>
        <td><input name="txtCa8" type="text" value="567" /></td>
        <td><input name="txtCa32" type="text" value="187" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">September</div></td>
        <td><input name="txtCa21" type="text" value="789" /></td>
        <td><input name="txtCa9" type="text" value="234" /></td>
        <td><input name="txtCa33" type="text" value="187" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">Oktober</div></td>
        <td><input name="txtCa22" type="text" value="345" /></td>
        <td><input name="txtCa10" type="text" value="456" /></td>
        <td><input name="txtCa34" type="text" value="126" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">November</div></td>
        <td><input name="txtCa23" type="text" value="656" /></td>
        <td><input name="txtCa11" type="text" value="123" /></td>
        <td><input name="txtCa35" type="text" value="187" /></td>
      </tr>
      <tr>
        <td align="center"><div align="right">Disember</div></td>
        <td><input name="txtCa24" type="text" value="234" /></td>
        <td><input name="txtCa12" type="text" value="765" /></td>
        <td><input name="txtCa36" type="text" value="187" /></td>
      </tr>
      <tr>
        <td colspan="2" align="center"><div align="right">Jumlah* </div></td>
        <td><input name="txtCa37" type="text" value="4857" /></td>
        <td><input name="txtCa38" type="text" value="1532" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
