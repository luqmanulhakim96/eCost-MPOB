...
<table class="tableCss" align="left">
  <tr>
    ...
    <td colspan="4"><b>TAHUN KETIGA&nbsp;(Ditanam pada tahun 2006)&nbsp;</b></td>
  </tr>
  <tr>
    <td height="20"></td>
  </tr>
  ...
  <tr>
    <td></td>
    <td colspan="4">Penukaran dari Tanaman Lain&nbsp;</td>
    </tr>
  <tr>
    <td height="20"></td>
  </tr>
  ...
  <tr>
    ...
    <td width="136"><b>Kos&nbsp;(RM)</b></td>
    <td width="131"><b>Kos(RM)/Ha&nbsp;</b></td>
    <td width="346"><b>(~ Tahun Sebelum)</b></td>
  </tr>
  <tr>
    <td></td>
    <td colspan="4"><table width="80%"  frame="box" class="subTable">
      <tr>
        ...
        <td width="145"><input name="txtCa13" type="text" onblur="kiraTotal(this.value,'txtCa25')" onkeyup="kira('31','32','txtCa25','txtCa',this.value)" value="0" size="15"/></td>
        <td width="145"><input name="txtCa25" type="text" id="txtCa25" value="0" size="10" /></td>
        <td width="145"><input name="txtCa" type="text" id="txtCa" value="0" size="10" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="txtCa28" type="text" value="0" size="10" id="txtCa28" /></td>
        <td><input name="txtCa4" type="text" value="0" size="10" id="txtCa4" /></td>
      </tr>
      <tr>
        <td align="center">5.</td>
        <td>Pemuliharan tanah/air</td>
        <td><input name="txtCa17" type="text" onblur="kiraTotal(this.value,'txtCa29')" onkeyup="kira('31','32','txtCa29','txtCa5',this.value)" value="0" size="15"/>        </td>
      ...
      <tr>
        ...
        <td><input name="txtCa18" type="text" onkeyup="kira('31','32','txtCa30','txtCa6',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa19" type="text" onkeyup="kira('31','32','txtCa31','txtCa7',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td>Banci/sulaman&nbsp;</td>
        <td><input name="txtCa20" type="text" onkeyup="kira('31','32','txtCa32','txtCa8',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td>Memangkas&nbsp;</td>
        <td><input name="txtCa21" type="text" onkeyup="kira('31','32','txtCa33','txtCa9',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa22" type="text" onkeyup="kira('31','32','txtCa34','txtCa10',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td>Pengkasian&nbsp;</td>
        <td><input name="txtCa23" type="text" onkeyup="kira('31','32','txtCa35','txtCa11',this.value)" value="0" size="15"/></td>
      ...
      <tr>
        ...
        <td><input name="txtCa24" type="text" onkeyup="kira('31','32','txtCa36','txtCa12',this.value)" value="0" size="15"/></td>
  ...
  <tr>
    ...
    <td colspan="4"><table width="80%" frame="box" class="subTable">
      <tr>
        ...
        <td width="247"><input name="txtCb1" type="text" value="0" /></td>
      </tr>
      <tr>
        <td align="right">2.</td>
        <td>Upah Membaja&nbsp;</td>
