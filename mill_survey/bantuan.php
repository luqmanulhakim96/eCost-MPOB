...
<table width="80%" border="0" align="center">
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" align="center" style="border:#333333 1px solid;">
      <tr>
        <td width="33%"><u><strong><?=setstring ( 'mal', 'Singkatan', 'en', 'Symbol'); ?></strong></u></td>
        <td width="67%"><strong><u>Penerangan</u></strong></td>
      </tr>
      <tr>
        <td><img src="../images/warning_16.png" width="16" height="16"></td>
        <td><?=setstring ( 'mal', 'Soalan survei yang belum dilengkapkan', 'en', 'Incomplete survey questions'); ?> </td>
      </tr>
      <tr>
        <td><img src="../images/accepted_48.png" width="16" height="16"></td>
        <td> <?=setstring ( 'mal', 'Soalan survei yang sudah dilengkapkan', 'en', 'Completed survey questions'); ?></td>
      </tr>
      <tr>
