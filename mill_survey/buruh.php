    ...
    <tr>
      <td><table width="90%" align="center" cellspacing="0"  frame="box" class="subTable">
          ...
          <tr>
            ...
            <?php if($_SESSION['view']!="true"){ ?>    <input name="mb_1" type="text" class="field_active" id="mb_1" onchange="kiraan_baru(this.value, '<?php echo $buruh->mb_1;?>','total_mb')" value="<?php echo $buruh->mb_1; ?>" size="10" readonly="true" autocomplete="off"  />
<?php } ?>
...
<?php } ?>
          ...
          <tr>
            ...
            <td align="center">
            <?php if($_SESSION['view']!="true"){ ?><input name="mb_2" type="text" class="field_active" id="mb_2" onchange="kiraan_baru(this.value, '<?php echo $buruh->mb_2;?>','total_mb')" value="<?php echo $buruh->mb_2; ?>" size="10" readonly="true" autocomplete="off" />
<?php } ?>
...
<?php if($_SESSION['view']=="true"){ ?><?php echo $buruh->mb_2c; ?>
<?php } ?></td>
          </tr>
          <tr>
            <td height="37" align="left" bgcolor="#99FF99"><div align="left">3. <?=setstring ( 'mal', 'Pekerja kilang', 'en', 'Mill worker'); ?></div></td>
            <td align="center" bgcolor="#99FF99"><?php if($_SESSION['view']!="true"){ ?><input name="mb_3" type="text" class="field_active" id="mb_3" onchange="kiraan_baru(this.value, '<?php echo $buruh->mb_3;?>','total_mb')" value="<?php echo $buruh->mb_3; ?>" size="10" readonly="true" autocomplete="off" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php echo $buruh->mb_3; ?>
<?php } ?>
            ...
            <td align="center" bgcolor="#99FF99">
            <?php if($_SESSION['view']!="true"){ ?><input name="mb_3b" type="text" class="field_active" id="mb_3b" onchange="kiraan_baru(this.value, '<?php echo $buruh->mb_3b;?>','total_mb_b')" value="<?php echo $buruh->mb_3b; ?>" size="10" readonly="true" autocomplete="off"/>
<?php } ?>
...
<?php if($_SESSION['view']=="true"){ ?><?php echo $buruh->mb_3c; ?>
<?php } ?>
</td>
          </tr>
          <tr>
            ...
            <td align="center">
            <?php if($_SESSION['view']!="true"){ ?>  <input name="mb_4" type="text" class="field_active" id="mb_4" onchange="kiraan_baru(this.value, '<?php echo $buruh->mb_4;?>','total_mb')" value="<?php echo $buruh->mb_4; ?>" size="10" readonly="true" autocomplete="off"/>
<?php } ?>
...
<?php if($_SESSION['view']=="true"){ ?><?php echo $buruh->mb_4c; ?>
<?php } ?>
           </td>
          </tr>
          <tr>
            ...
            <td align="center" bgcolor="#99FF99">
            <?php if($_SESSION['view']!="true"){ ?> <input name="mb_5" type="text" class="field_active" id="mb_5" onchange="kiraan_baru(this.value, '<?php echo $buruh->mb_5;?>','total_mb')" value="<?php echo $buruh->mb_5; ?>" size="10" readonly="true" autocomplete="off"/>
<?php } ?>
...
<?php if($_SESSION['view']=="true"){ ?><?php echo $buruh->mb_5c; ?>
<?php } ?>
            </td>
          </tr>
          <tr bgcolor="#FFFFCC">
...
<?php } ?>
    ...
    <tr>
      <td><div align="center">
          ...
          <input type="button" name="button" id="button" value=<?=setstring ( 'mal', '"Simpan &amp; Sahkan"', 'en', '"Save &amp; Verify"'); ?> onclick="hantar(1)"/>
