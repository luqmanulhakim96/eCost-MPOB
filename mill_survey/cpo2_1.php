...
&nbsp;</span></td>
            <td width="164" align="center" valign="middle" bgcolor="#99FF99"><label>
                <div align="center">
                  <?php if($_SESSION['view']!="true"){ ?><input name="kp_1" type="text" class="field_active" id="kp_1" onchange="field_blur(this,'bts_tan_1','bts_beza_1',this.value,'<?= $proses->kp_1; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_1,2); ?>" />
<?php } ?>
...
&nbsp;</td>
            <td align="center" valign="middle"><div align="center">
              <?php if($_SESSION['view']!="true"){ ?><input name="kp_2" type="text" class="field_active" id="kp_2" onchange="field_blur(this,'bts_tan_2','bts_beza_2',this.value,'<?= $proses->kp_2; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_2,2); ?>" />
<?php } ?>
...
&nbsp;</td>
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
               <?php if($_SESSION['view']!="true"){ ?> <input name="kp_3" type="text" class="field_active" id="kp_3" onchange="field_blur(this,'bts_tan_3','bts_beza_3',this.value,'<?= $proses->kp_3; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_3,2); ?>" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php echo number_format($proses->kp_3,2); ?>
<?php } ?>
            </div></td>
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
          ...
          <tr>
            ...
            <td align="center" valign="middle"><div align="center">
               <?php if($_SESSION['view']!="true"){ ?><input name="kp_4" type="text" class="field_active" id="kp_4" onchange="field_blur(this,'bts_tan_4','bts_beza_4',this.value,'<?= $proses->kp_4; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_4,2); ?>" />
<?php } ?>
...
<?php } ?> 
          ...
          <tr>
            ...
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
               <?php if($_SESSION['view']!="true"){ ?> <input name="kp_5" type="text" class="field_active" id="kp_5" onchange="field_blur(this,'bts_tan_5','bts_beza_5',this.value,'<?= $proses->kp_5; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_5,2); ?>" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php echo number_format($proses->kp_5,2); ?>
<?php } ?>
            </div></td>
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
...
&nbsp;</td>
            <td align="center" valign="middle"><div align="center">
                <?php if($_SESSION['view']!="true"){ ?><input name="kp_6" type="text" class="field_active" id="kp_6" onchange="field_blur(this,'bts_tan_6','bts_beza_6',this.value,'<?= $proses->kp_6; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_6,2); ?>" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php echo number_format($proses->kp_6,2); ?>
<?php } ?>
            </div></td>
            <td align="center" valign="middle"><div align="center">
          ...
          <tr>
            ...
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
               <?php if($_SESSION['view']!="true"){ ?><input name="kp_7" type="text" class="field_active" id="kp_7" onchange="field_blur(this,'bts_tan_7','bts_beza_7',this.value,'<?= $proses->kp_7; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_7,2); ?>" />
<?php } ?>
...
<?php } ?> 
          ...
          <tr>
            ...
            <td align="center" valign="middle"><div align="center">
               <?php if($_SESSION['view']!="true"){ ?><input name="kp_8" type="text" class="field_active" id="kp_8" onchange="field_blur(this,'bts_tan_8','bts_beza_8',this.value,'<?= $proses->kp_8; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_8,2); ?>" />
<?php } ?>
...
<?php } ?> 
          ...
          <tr>
            ...
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
               <?php if($_SESSION['view']!="true"){ ?><input name="kp_9" type="text" class="field_active" id="kp_9" onchange="field_blur(this,'bts_tan_9','bts_beza_9',this.value,'<?= $proses->kp_9; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_9,2); ?>" />
<?php } ?>
...
<?php } ?> 
          ...
          <tr>
            ...
            <td align="center" valign="middle"><div align="center">
              <?php if($_SESSION['view']!="true"){ ?> <input name="kp_10" type="text" class="field_active" id="kp_10" onchange="field_blur(this,'bts_tan_10','bts_beza_10',this.value,'<?= $proses->kp_10; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_10,2); ?>" />
<?php } ?>
...
<?php } ?> 
          ...
          <tr>
            ...
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
               <?php if($_SESSION['view']!="true"){ ?><input name="kp_11" type="text" class="field_active" id="kp_11" onchange="field_blur(this,'bts_tan_11','bts_beza_11',this.value,'<?= $proses->kp_11; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_11,2); ?>" />
<?php } ?>
...
<?php } ?> 
          ...
          <tr>
            ...
            <td align="center" valign="middle"><div align="center">
              <?php if($_SESSION['view']!="true"){ ?> <input name="kp_12" type="text" class="field_active" id="kp_12" onchange="field_blur(this,'bts_tan_12','bts_beza_12',this.value,'<?= $proses->kp_12; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_12,2); ?>" />
<?php } ?>
...
<?php } ?> 
          ...
          <tr>
            ...
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
             <?php if($_SESSION['view']!="true"){ ?><input name="kp_13" type="text" class="field_active" id="kp_13" onchange="field_blur(this,'bts_tan_13','bts_beza_13',this.value,'<?= $proses->kp_13; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_13,2); ?>" />
<?php } ?>
...
<?php } ?>   
          ...
          <tr>
            ...
            <td align="center" valign="middle"><div align="center">
              <?php if($_SESSION['view']!="true"){ ?> <input name="kp_14" type="text" class="field_active" id="kp_14" onchange="field_blur(this,'bts_tan_14','bts_beza_14',this.value,'<?= $proses->kp_14; ?>','total_kp','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->kp_14,2); ?>" />
<?php } ?>
...
<?php if($_SESSION['view']=="true"){ ?><?php echo number_format($proses->kp_15,2); ?>
<?php } ?>
           </td>
            <td align="center" valign="middle" bgcolor="#99FF99"><div align="center">
          ...
          <tr>
            ...
            <td align="center" valign="middle" bgcolor="#FFCC66"><div align="center">
              <?php if($_SESSION['view']!="true"){ ?>  <input name="total_kp" type="text" class="field_active" id="total_kp" onblur="field_blur(this)" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($proses->total_kp,2); ?>" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php echo number_format($proses->total_kp,2); ?>
<?php } ?>
