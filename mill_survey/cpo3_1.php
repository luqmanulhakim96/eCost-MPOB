...
<?php } ?>
          ...
          <tr>
            ...
            <?php if($_SESSION['view']!="true"){ ?><input name="kl_2" type="text" autocomplete="off" class="field_active" id="kl_2" onchange="field_blur(this,'bts_tan_2','bts_beza_2',this.value,'<?= $koslain->kl_2; ?>','total_kl','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($koslain->kl_2,2); ?>" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php echo number_format($koslain->kl_2,2); ?>
<?php } ?>
            </td>
...
<?php } ?>
          ...
          <tr>
            ...
            <td align="center" valign="middle">
            <?php if($_SESSION['view']!="true"){ ?><input name="kl_4" type="text" autocomplete="off" class="field_active" id="kl_4" onchange="field_blur(this,'bts_tan_4','bts_beza_4',this.value,'<?= $koslain->kl_1; ?>','total_kl','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($koslain->kl_4,2); ?>" />
<?php } ?>
...
<?php } ?>
          ...
          <tr bgcolor="#99FF99">
            ...
            <td align="center" valign="middle">
            <?php if($_SESSION['view']!="true"){ ?>     <input name="kl_5" type="text" autocomplete="off" class="field_active" id="kl_5" onchange="field_blur(this,'bts_tan_5','bts_beza_5',this.value,'<?= $koslain->kl_4; ?>','total_kl','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onKeypress="keypress(event)" value="<?php echo number_format($koslain->kl_5,2); ?>" />
<?php } ?>

<?php if($_SESSION['view']=="true"){ ?><?php echo number_format($koslain->kl_5,2); ?>
<?php } ?>
       </td>
          ...
          <tr bgcolor="#FFFFCC">
            ...
            <td align="center" style="border-top:solid #333333 1px;" valign="middle">
            <?php if($_SESSION['view']!="true"){ ?> <input name="total_kl" type="text" class="field_active" id="total_kl" onchange="field_blur(this,'bts_tan_5','bts_beza_5',this.value,'<?= $koslain->kl_5; ?>','total_kl','total_bts_tan', 'total_bts_beza')" onclick="field_click(this)" onkeypress="keypress(event)" value="<?php echo number_format($koslain->total_kl,2); ?>" readonly="true" autocomplete="off"/>
<?php } ?>
