...
?>
	...
	?>
          <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" id="box-table-a">
            <tr>
              <th height="36" colspan="4"><strong><?=setstring ( 'mal', 'Maklumat Am', 'en', 'General Information'); ?></strong></th>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><strong>:</strong></td>
              <td colspan="2">
              <input name="lesen" type="text" autocomplete="off" id="lesen" value="<?= $pengguna->lesen; ?>" size="50" /></td>
            </tr>
            <tr>
